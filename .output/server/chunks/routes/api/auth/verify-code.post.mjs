import { d as defineEventHandler, r as readBody, c as createError, v as verifyNotificoreOtp, m as isNotificoreTimeoutError } from '../../../nitro/nitro.mjs';
import 'better-auth';
...
const verifyCode_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    throw createError({
      ...
      message: upstreamStatus === 422 ? "\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u043A\u043E\u0434 \u0438\u0437 \u0421\u041C\u0421" : "\u041A\u043E\u0434 \u043D\u0435 \u043F\u043E\u0434\u043E\u0448\u0435\u043B :( \u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0435\u0433\u043E \u0438\u043B\u0438\xA0\u043F\u043E\u043B\u0443\u0447\u0438\u0442\u0435\xA0\u043F\u043E\u0432\u0442\u043E\u0440\u043D\u043E \u0447\u0435\u0440\u0435\u0437 60 \u0441\u0435\u043A\u0443\u043D\u0434"
    });
  }
});
