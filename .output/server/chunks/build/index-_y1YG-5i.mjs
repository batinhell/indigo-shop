...
import { _ as _export_sfc, c as useRoute, p as useProfileStore, v as navigateTo, aM as useFavorites, g as __nuxt_component_1$1$1, b as __nuxt_component_0$1$1, q as __nuxt_component_0$5, j as _sfc_main$j, e as useCart, d as useFetch, a as __nuxt_component_0$4$1, w as setInterval, s as authClient, h as _sfc_main$w } from './server.mjs';
...
import { ay as formatCompactPhone, ax as getRussianSecondsWord, b as normalizePhoneDigits } from '../nitro/nitro.mjs';
import { _ as __nuxt_component_0$4 } from './AppSwitch-Bzlh0bNE.mjs';
...
const _sfc_main$g = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "profile-sidebar app-card" }, _attrs))} data-v-5f91dd17><nav class="profile-sidebar__nav" data-v-5f91dd17><!--[-->`);
      ssrRenderList(unref(navItems), (item) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "profile-sidebar__link--active": __props.activeItem === item.key }, "profile-sidebar__link"])}" data-v-5f91dd17><span class="profile-sidebar__label" data-v-5f91dd17>${ssrInterpolate(item.label)}</span>`);
        if (item.badge) {
          _push(`<span class="${ssrRenderClass([`profile-sidebar__badge--${item.badgeType}`, "profile-sidebar__badge"])}" data-v-5f91dd17>${ssrInterpolate(item.badge)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</button>`);
      });
      _push(`<!--]--></nav><button type="button" class="profile-sidebar__logout" data-v-5f91dd17><span class="profile-sidebar__logout-label" data-v-5f91dd17>Выйти</span>`);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-5f91dd17"]]);
...
const _sfc_main$f = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppIcon = __nuxt_component_1$1$1;
      const _component_AppInput = __nuxt_component_0$1$1;
      _push(ssrRenderComponent(_component_UModal, mergeProps({
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="auth-entry auth-entry--profile-phone" data-v-82babd3f${_scopeId}><header class="auth-entry__header" data-v-82babd3f${_scopeId}><div class="auth-entry__title-block" data-v-82babd3f${_scopeId}><h2 class="auth-entry__title" data-v-82babd3f${_scopeId}> Изменение номера </h2></div><button type="button" class="auth-entry__close" aria-label="Закрыть изменение номера" data-v-82babd3f${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppIcon, {
              name: "close",
              size: 16,
              class: "auth-entry__close-icon"
            }, null, _parent2, _scopeId));
            _push2(`</button></header><div class="auth-entry__code-fields" data-v-82babd3f${_scopeId}>`);
            if (unref(isPhoneConfirmed)) {
              _push2(`<div class="auth-entry__registration-phone auth-entry__registration-phone--confirmed" data-v-82babd3f${_scopeId}><div class="auth-entry__field auth-entry__field--compact auth-entry__phone-field auth-entry__phone-field--confirmed" data-v-82babd3f${_scopeId}><label class="auth-entry__label"${ssrRenderAttr("for", phoneInputId)} data-v-82babd3f${_scopeId}> Номер телефона </label>`);
              ...
              _push2(`</div><div class="auth-entry__confirmed-badge" data-v-82babd3f${_scopeId}> Сохранен </div></div>`);
            } else if (unref(isCodeRequestSent)) {
              _push2(`<!--[--><div class="auth-entry__registration-phone auth-entry__registration-phone--code" data-v-82babd3f${_scopeId}><div class="auth-entry__field auth-entry__field--compact auth-entry__phone-field" data-v-82babd3f${_scopeId}><label class="auth-entry__label"${ssrRenderAttr("for", phoneInputId)} data-v-82babd3f${_scopeId}> Номер телефона </label>`);
              _push2(ssrRenderComponent(_component_AppInput, {
                id: phoneInputId,
                modelValue: unref(phone),
                "onUpdate:modelValue": ($event) => isRef(phone) ? phone.value = $event : null,
              ...
              _push2(`</span></div></div><button type="button" class="${ssrRenderClass([{ "auth-entry__resend--active": unref(canResendCode) }, "auth-entry__resend"])}"${ssrIncludeBooleanAttr(!unref(canResendCode)) ? " disabled" : ""} data-v-82babd3f${_scopeId}>${ssrInterpolate(unref(resendButtonText))}</button><!--]-->`);
            } else {
              _push2(`<!--[--><div class="auth-entry__registration-phone" data-v-82babd3f${_scopeId}><div class="auth-entry__field auth-entry__field--compact auth-entry__phone-field" data-v-82babd3f${_scopeId}><label class="auth-entry__label"${ssrRenderAttr("for", phoneInputId)} data-v-82babd3f${_scopeId}> Номер телефона </label>`);
              _push2(ssrRenderComponent(_component_AppInput, {
                id: phoneInputId,
              ...
              _push2(`</div><button type="button" class="auth-entry__code-button"${ssrIncludeBooleanAttr(!unref(canRequestCode) || unref(isCodeRequestPending)) ? " disabled" : ""} data-v-82babd3f${_scopeId}>${ssrInterpolate(unref(isCodeRequestPending) ? "Отправляем" : "Получить код")}</button></div><p class="auth-entry__hint" data-v-82babd3f${_scopeId}> Отправим вам смс с кодом подтверждения </p><!--]-->`);
            }
            if (unref(codeRequestError) || unref(codeVerifyError)) {
              _push2(`<p class="auth-entry__request-status auth-entry__request-status--error" data-v-82babd3f${_scopeId}>${ssrInterpolate(unref(codeRequestError) || unref(codeVerifyError))}</p>`);
            } else if (unref(isCodeRequestSent) && !unref(isPhoneConfirmed)) {
              _push2(`<p class="auth-entry__request-status" data-v-82babd3f${_scopeId}> Код отправлен </p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></section>`);
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-82babd3f"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UModal, mergeProps({
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="email-confirm-modal" data-v-3a822eae${_scopeId}><header class="email-confirm-modal__header" data-v-3a822eae${_scopeId}><div class="email-confirm-modal__title-block" data-v-3a822eae${_scopeId}><h2 class="email-confirm-modal__title" data-v-3a822eae${_scopeId}> Проверьте почту </h2><div class="email-confirm-modal__text" data-v-3a822eae${_scopeId}><p data-v-3a822eae${_scopeId}> Мы отправили письмо со ссылкой для подтверждения на почту ${ssrInterpolate(__props.email)}. </p><p data-v-3a822eae${_scopeId}> Если вы его не получили,<br data-v-3a822eae${_scopeId}> проверьте папку Спам или<br data-v-3a822eae${_scopeId}> напишите нам <a class="email-confirm-modal__link"${ssrRenderAttr("href", `mailto:${supportEmail$1}`)} target="_blank" rel="noopener noreferrer" data-v-3a822eae${_scopeId}>на ${ssrInterpolate(supportEmail$1)}</a></p></div></div><button type="button" class="email-confirm-modal__close" aria-label="Закрыть подтверждение почты" data-v-3a822eae${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppIcon, {
              name: "close",
              size: 16,
              class: "email-confirm-modal__close-icon"
            }, null, _parent2, _scopeId));
            _push2(`</button></header><button type="button" class="email-confirm-modal__button" data-v-3a822eae${_scopeId}> Хорошо </button></section>`);
          } else {
            return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-3a822eae"]]);
const phoneMask = "+7(###)-###-##-##";
const _sfc_main$d = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ProfilePhoneEditModal = __nuxt_component_0$2;
      const _component_ProfileEmailConfirmModal = __nuxt_component_1;
      const _component_AppInput = __nuxt_component_0$1$1;
      const _component_AppIcon = __nuxt_component_1$1$1;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-personal app-card" }, _attrs))} data-v-b5130e70>`);
      ...
      _push(`<h2 class="profile-personal__title" data-v-b5130e70> Данные пользователя </h2><div class="profile-personal__body" data-v-b5130e70><div class="profile-personal__fields" data-v-b5130e70><div class="profile-field" data-v-b5130e70><label class="profile-field__label" data-v-b5130e70> Имя </label>`);
      ...
      _push(`</div><div class="profile-field profile-field--phone" data-v-b5130e70><label class="profile-field__label" data-v-b5130e70> Номер телефона </label>`);
      _push(ssrRenderComponent(_component_AppInput, {
        id: "profile-phone",
        ...
        suffix: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button type="button" class="profile-field__icon-button" aria-label="Редактировать номер телефона" data-v-b5130e70${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppIcon, {
              name: "profile-edit",
              size: "12",
      ...
      _push(`</div><div class="profile-personal__email-row" data-v-b5130e70><div class="profile-field" data-v-b5130e70><label class="profile-field__label" data-v-b5130e70> Электронная почта </label>`);
      _push(ssrRenderComponent(_component_AppInput, {
        id: "profile-email",
        ...
        suffix: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button type="button" class="profile-field__icon-button" aria-label="Редактировать почту" data-v-b5130e70${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppIcon, {
              name: "profile-edit",
              size: "12",
              class: "profile-field__icon"
      ...
      if (unref(showEmailActions)) {
        _push(`<div class="profile-personal__email-actions" data-v-b5130e70><button type="button" class="profile-personal__email-save"${ssrIncludeBooleanAttr(unref(isEmailSaving)) ? " disabled" : ""} data-v-b5130e70> Сохранить </button><button type="button" class="profile-personal__email-cancel"${ssrIncludeBooleanAttr(unref(isEmailSaving)) ? " disabled" : ""} data-v-b5130e70> Отменить </button></div>`);
      } else if (email.value && !__props.isEmailVerified) {
        _push(`<button type="button" class="profile-personal__confirm"${ssrIncludeBooleanAttr(unref(isEmailConfirmationSending)) ? " disabled" : ""} data-v-b5130e70>${ssrInterpolate(unref(isEmailConfirmationSending) ? "Отправляем" : "Подтвердить")}</button>`);
      } else if (email.value && __props.isEmailVerified) {
        _push(`<span class="profile-personal__verified" data-v-b5130e70> Подтверждена </span>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(emailConfirmationError)) {
        _push(`<p class="profile-personal__email-error" data-v-b5130e70>${ssrInterpolate(unref(emailConfirmationError))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="profile-field" data-v-b5130e70><label class="profile-field__label" data-v-b5130e70> Дополнительный контакт </label>`);
      _push(ssrRenderComponent(_component_AppInput, {
      ...
      _push(`</div></div><div class="profile-recipient" data-v-b5130e70><div class="profile-recipient__header" data-v-b5130e70><h3 class="profile-recipient__title" data-v-b5130e70> Получатель </h3><p class="profile-recipient__subtitle" data-v-b5130e70> Человек, который получит заказ </p></div>`);
      if (unref(recipientForms).length) {
        _push(`<div class="profile-recipient__forms" data-v-b5130e70><!--[-->`);
        ssrRenderList(unref(recipientForms), (recipient) => {
          _push(`<article class="profile-recipient-form" data-v-b5130e70><div class="profile-field" data-v-b5130e70><label class="profile-field__label" data-v-b5130e70> Имя </label>`);
          _push(ssrRenderComponent(_component_AppInput, {
            ...
            suffix: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button type="button" class="profile-field__icon-button" aria-label="Редактировать имя получателя" data-v-b5130e70${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
                  name: "profile-edit",
                  size: "12",
                  class: "profile-field__icon"
          ...
          _push(ssrRenderComponent(_component_AppInput, {
            ...
            suffix: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button type="button" class="profile-field__icon-button" aria-label="Редактировать номер получателя" data-v-b5130e70${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
                  name: "profile-edit",
                  size: "12",
                  class: "profile-field__icon"
          ...
          _push(`</div><div class="profile-recipient-form__actions" data-v-b5130e70><button type="button" class="profile-recipient-form__remove" data-v-b5130e70>`);
          _push(ssrRenderComponent(_component_AppIcon, {
            name: "profile-trash",
            size: "12",
            class: "profile-recipient-form__action-icon"
          }, null, _parent));
          _push(`<span data-v-b5130e70>Удалить</span></button>`);
          if (canSaveRecipient(recipient)) {
            _push(`<button type="button" class="profile-recipient-form__save" data-v-b5130e70> Сохранить </button>`);
          } else if (recipient.isSaveNoticeVisible) {
            _push(`<span class="profile-recipient-form__saved" data-v-b5130e70> Сохранен </span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></article>`);
      ...
      _push(`<div class="profile-recipient__toggle" data-v-b5130e70><div class="profile-recipient__toggle-copy" data-v-b5130e70><span class="profile-recipient__toggle-title" data-v-b5130e70>Добавить получателя</span><span class="profile-recipient__toggle-text" data-v-b5130e70> Добавьте людей, которые могут получить заказ за вас </span></div><button type="button" class="profile-recipient__add" data-v-b5130e70>`);
      _push(ssrRenderComponent(_component_AppIcon, {
        name: "profile-plus",
        size: "10",
        class: "profile-recipient__button-icon"
      }, null, _parent));
      _push(`<span data-v-b5130e70>Добавить</span></button></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-b5130e70"]]);
...
const _sfc_main$c = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AppIcon = __nuxt_component_1$1$1;
      const _component_AppInput = __nuxt_component_0$1$1;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-organizations app-card" }, _attrs))} data-v-a9006dd0><h2 class="profile-organizations__title" data-v-a9006dd0> Организации </h2><div class="profile-organizations__body" data-v-a9006dd0>`);
      if (unref(displayOrganizations).length) {
        _push(`<div class="profile-organizations__list" data-v-a9006dd0><!--[-->`);
        ssrRenderList(unref(displayOrganizations), (organization) => {
          _push(`<article class="${ssrRenderClass([{ "profile-organization--active": organization.active }, "profile-organization"])}" data-v-a9006dd0><div class="profile-organization__top" data-v-a9006dd0><span class="profile-organization__radio-wrap" data-v-a9006dd0><button type="button" class="${ssrRenderClass([{ "profile-organization__radio--active": organization.active }, "profile-organization__radio"])}"${ssrIncludeBooleanAttr(unref(pendingActiveId) === organization.id) ? " disabled" : ""}${ssrRenderAttr("aria-pressed", organization.active)}${ssrRenderAttr("aria-label", organization.active ? "Активная организация" : "Сделать организацию активной")} data-v-a9006dd0></button></span><button type="button" class="profile-organization__delete"${ssrIncludeBooleanAttr(unref(pendingDeleteId) === organization.id) ? " disabled" : ""} data-v-a9006dd0>${ssrInterpolate(unref(pendingDeleteId) === organization.id ? "Удаляем" : "Удалить")}</button></div><div class="profile-organization__content" data-v-a9006dd0><h3 class="profile-organization__name" data-v-a9006dd0>${ssrInterpolate(organization.name)}</h3>`);
          if (organization.innLabel) {
            _push(`<p class="profile-organization__meta" data-v-a9006dd0>${ssrInterpolate(organization.innLabel)}</p>`);
          } else {
            _push(`<!---->`);
          }
          if (organization.address) {
            _push(`<p class="profile-organization__meta" data-v-a9006dd0>${ssrInterpolate(organization.address)}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></article>`);
      ...
      _push(`<div class="profile-organizations__add-row" data-v-a9006dd0><div class="profile-organizations__add-copy" data-v-a9006dd0><span class="profile-organizations__add-title" data-v-a9006dd0>Добавить организацию</span><span class="profile-organizations__add-text" data-v-a9006dd0> Чтобы платить безналом и пользоваться ЭДО </span></div><div class="profile-organizations__add-control" data-v-a9006dd0>`);
      if (!unref(isAddMode)) {
        _push(`<button type="button" class="profile-organizations__add" data-v-a9006dd0>`);
        _push(ssrRenderComponent(_component_AppIcon, {
          name: "profile-plus",
          size: "10",
          class: "profile-organizations__add-icon"
        }, null, _parent));
        _push(`<span data-v-a9006dd0>Добавить</span></button>`);
      } else {
        _push(`<div class="profile-organizations__add-input-wrap" data-v-a9006dd0>`);
        _push(ssrRenderComponent(_component_AppInput, {
          ref_key: "addInput",
          ref: addInput,
        ...
        if (unref(shouldShowOrganizationSuggestions)) {
          _push(`<div class="profile-organizations__options" data-v-a9006dd0>`);
          if (unref(isOrganizationSuggestPending)) {
            _push(`<p class="profile-organizations__status" data-v-a9006dd0> Ищем организацию </p>`);
          } else if (unref(organizationSuggestError)) {
            _push(`<p class="profile-organizations__status profile-organizations__status--error" data-v-a9006dd0>${ssrInterpolate(unref(organizationSuggestError))}</p>`);
          } else {
            _push(`<!--[-->`);
            ssrRenderList(unref(organizationSuggestions), (suggestion) => {
              _push(`<button type="button" class="profile-organizations__option" data-v-a9006dd0><span class="profile-organizations__option-name" data-v-a9006dd0>${ssrInterpolate(suggestion.name)}</span>`);
              if (suggestion.inn) {
                _push(`<span class="profile-organizations__option-meta" data-v-a9006dd0><span class="profile-organizations__option-prefix" data-v-a9006dd0>ИНН</span> ${ssrInterpolate(suggestion.inn)}</span>`);
              } else {
                _push(`<!---->`);
              }
              if (suggestion.address) {
                _push(`<span class="profile-organizations__option-meta" data-v-a9006dd0>${ssrInterpolate(suggestion.address)}</span>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</button>`);
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-a9006dd0"]]);
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-notifications app-card" }, _attrs))} data-v-99770ff2><h2 class="profile-notifications__title" data-v-99770ff2> Настройка уведомлений </h2><div class="profile-notifications__body" data-v-99770ff2><div class="profile-notifications__items" data-v-99770ff2><div class="profile-notification" data-v-99770ff2><div class="profile-notification__copy" data-v-99770ff2><span class="profile-notification__title" data-v-99770ff2>Email-уведомления</span><span class="profile-notification__text" data-v-99770ff2> Будем сообщать<br data-v-99770ff2> об изменении статуса заказа </span></div>`);
      ...
      _push(`</div><div class="profile-notification" data-v-99770ff2><div class="profile-notification__copy" data-v-99770ff2><span class="profile-notification__title" data-v-99770ff2>СМС-уведомления</span><span class="profile-notification__text" data-v-99770ff2> Будем сообщать<br data-v-99770ff2> о готовности заказа </span></div>`);
      _push(ssrRenderComponent(_component_AppSwitch, {
...
const __nuxt_component_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-99770ff2"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UModal, mergeProps({
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="password-recovery-sent-modal" data-v-8c64c564${_scopeId}><header class="password-recovery-sent-modal__header" data-v-8c64c564${_scopeId}><div class="password-recovery-sent-modal__title-block" data-v-8c64c564${_scopeId}><h2 class="password-recovery-sent-modal__title" data-v-8c64c564${_scopeId}> Проверьте почту </h2><div class="password-recovery-sent-modal__text" data-v-8c64c564${_scopeId}><p data-v-8c64c564${_scopeId}> Мы отправили письмо со ссылкой для сброса пароля на почту ${ssrInterpolate(__props.email)}. </p><p data-v-8c64c564${_scopeId}> Если вы его не получили,<br data-v-8c64c564${_scopeId}> проверьте папку Спам или<br data-v-8c64c564${_scopeId}> напишите нам <a class="password-recovery-sent-modal__link"${ssrRenderAttr("href", `mailto:${supportEmail}`)} target="_blank" rel="noopener noreferrer" data-v-8c64c564${_scopeId}>на ${ssrInterpolate(supportEmail)}</a></p></div></div><button type="button" class="password-recovery-sent-modal__close" aria-label="Закрыть уведомление о восстановлении пароля" data-v-8c64c564${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppIcon, {
              name: "close",
              size: 16,
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-8c64c564"]]);
const _sfc_main$9 = {
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-e521c523"]]);
const _sfc_main$8 = {
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-ddcc7a47"]]);
const _sfc_main$7 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-password app-card" }, _attrs))} data-v-92e92662><h2 class="profile-password__title" data-v-92e92662> Пароль </h2><div class="profile-password__content" data-v-92e92662>`);
      if (unref(isChangingPassword)) {
        _push(`<div class="profile-password-change" data-v-92e92662><div class="profile-password-change__field-group" data-v-92e92662><div class="profile-password-row__label-wrap" data-v-92e92662><span class="profile-password-row__label" data-v-92e92662>Изменение пароля</span></div>`);
        _push(ssrRenderComponent(_component_AppInput, {
          ...
          suffix: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(currentPasswordError) && unref(currentPassword)) {
                _push2(`<button type="button" class="profile-password-change__password-toggle profile-password-change__password-toggle--clear" aria-label="Очистить текущий пароль" data-v-92e92662${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
                  name: "reset",
                  size: 16,
                ...
                _push2(`<button type="button" class="profile-password-change__password-toggle"${ssrRenderAttr("aria-label", unref(isCurrentPasswordVisible) ? "Скрыть пароль" : "Показать пароль")} data-v-92e92662${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
          ...
          suffix: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(newPasswordError) && unref(newPassword)) {
                _push2(`<button type="button" class="profile-password-change__password-toggle profile-password-change__password-toggle--clear" aria-label="Очистить новый пароль" data-v-92e92662${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
                  name: "reset",
                  size: 16,
                  class: "profile-password-change__password-toggle-icon"
                ...
                _push2(`<button type="button" class="profile-password-change__password-toggle"${ssrRenderAttr("aria-label", unref(isNewPasswordVisible) ? "Скрыть пароль" : "Показать пароль")} data-v-92e92662${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
        ...
        if (unref(passwordChangeMessage)) {
          _push(`<div class="profile-password__saved" data-v-92e92662>${ssrInterpolate(unref(passwordChangeMessage))}</div>`);
        } else {
          _push(`<button type="button" class="profile-password__button profile-password__button--save"${ssrIncludeBooleanAttr(unref(passwordChangePending)) ? " disabled" : ""} data-v-92e92662>${ssrInterpolate(unref(passwordChangePending) ? "Сохраняем" : "Сохранить")}</button>`);
        }
        _push(`</div>`);
      } else {
        _push(`<div class="profile-password-row profile-password-row--current" data-v-92e92662><div class="profile-password-row__label-wrap" data-v-92e92662><span class="profile-password-row__label" data-v-92e92662>Текущий пароль</span></div><button type="button" class="profile-password__button" data-v-92e92662> Изменить </button></div>`);
      }
      if (unref(passwordChangeError)) {
        _push(`<p class="profile-password__status profile-password__status--error" data-v-92e92662>${ssrInterpolate(unref(passwordChangeError))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="profile-password-row profile-password-row--recovery" data-v-92e92662><div class="profile-password-row__label-wrap" data-v-92e92662><span class="profile-password-row__label" data-v-92e92662>Забыли пароль?</span></div><button type="button" class="profile-password__button"${ssrIncludeBooleanAttr(unref(isPasswordRecoveryPending)) ? " disabled" : ""} data-v-92e92662>${ssrInterpolate(unref(isPasswordRecoveryPending) ? "Отправляем" : "Восстановить")}</button></div>`);
      if (unref(passwordRecoveryError)) {
        _push(`<p class="profile-password__status profile-password__status--error" data-v-92e92662>${ssrInterpolate(unref(passwordRecoveryError))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_5 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-92e92662"]]), { __name: "ProfilePasswordSettings" });
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-ade481c4"]]);
const _sfc_main$5 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AppIcon = __nuxt_component_1$1$1;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-save-bar" }, _attrs))} data-v-59866aca><p class="${ssrRenderClass([{ "profile-save-bar__status--error": __props.error }, "profile-save-bar__status"])}" data-v-59866aca>${ssrInterpolate(__props.error || "Изменения не сохранены")}</p><div class="profile-save-bar__actions" data-v-59866aca><button type="button" class="profile-save-bar__cancel"${ssrIncludeBooleanAttr(__props.pending) ? " disabled" : ""} data-v-59866aca> Отмена </button><button type="button" class="profile-save-bar__save"${ssrIncludeBooleanAttr(__props.pending) ? " disabled" : ""} data-v-59866aca>`);
      if (!__props.pending) {
        _push(ssrRenderComponent(_component_AppIcon, {
          name: "profile-check",
          size: "10",
      ...
      _push(`<span data-v-59866aca>${ssrInterpolate(__props.pending ? "Сохраняем" : "Сохранить изменения")}</span></button></div></section>`);
    };
  }
};
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-59866aca"]]);
const _sfc_main$4 = {
  __name: "ProfileOrderItem",
  __ssrInlineRender: true,
  props: {
    to: {
      type: String,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$4$1;
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "profile-order-item__top" }, [
                createVNode("div", { class: "profile-order-item__details" }, [
                  createVNode("div", { class: "profile-order-item__title-row" }, [
                    createVNode("span", {
                      class: ["profile-order-item__status", `profile-order-item__status--${unref(statusToneName)}`]
                    }, toDisplayString(unref(statusLabelText)), 3),
                    createVNode("span", { class: "profile-order-item__number" }, toDisplayString(__props.number), 1)
                  ]),
                  createVNode("div", { class: "profile-order-item__meta" }, [
                    createVNode("span", null, toDisplayString(__props.date), 1),
                    createVNode("span", { "aria-hidden": "true" }, "·"),
                    createVNode("span", null, toDisplayString(__props.delivery), 1)
                  ])
                ]),
                createVNode("div", { class: "profile-order-item__actions" }, [
                  createVNode("button", {
                    type: "button",
                    class: "profile-order-item__button profile-order-item__button--secondary",
                    onClick: withModifiers(($event) => emit("repeat"), ["prevent", "stop"]),
                    onMousedown: withModifiers(() => {
                    }, ["stop"])
                  }, " Повторить ", 40, ["onClick", "onMousedown"]),
                  createVNode("span", { class: "profile-order-item__button profile-order-item__button--primary" }, " Подробнее ")
                ])
              ]),
              createVNode("div", { class: "profile-order-item__bottom" }, [
                createVNode("div", {
                  class: "profile-order-item__items-wrap",
                  onClick: withModifiers(() => {
                  }, ["stop"]),
                  onWheel: withModifiers(onItemsWheel, ["stop"])
                }, [
                  createVNode("div", {
                    ref_key: "itemsScroller",
                    ref: itemsScroller,
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.items, (item, index2) => {
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "profile-order-product__name" }, toDisplayString(item.name), 1),
                        createVNode("div", { class: "profile-order-product__options" }, [
                          createVNode("span", null, toDisplayString(item.size || item.sizeLabel || "—"), 1),
                          createVNode("span", { "aria-hidden": "true" }, "·"),
                          createVNode("span", null, toDisplayString(item.quantity || item.quantityLabel), 1)
                        ])
                      ]);
                    }), 128))
                  ], 512)
                ], 40, ["onClick"]),
                createVNode("div", { class: "profile-order-item__fade" }),
                createVNode("div", { class: "profile-order-item__price" }, [
                  createVNode("span", { class: "profile-order-item__price-value" }, toDisplayString(__props.price), 1),
                  createVNode("span", { class: "profile-order-item__price-caption" }, toDisplayString(__props.positions), 1)
                ])
              ])
            ];
          }
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    function repeatOrder(order) {
      const cartItems = (order.items || []).map((item) => item.cartItem).filter(Boolean);
      if (!cartItems.length) return;
      cartItems.forEach((item) => addExistingItem(item));
    }
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ProfileOrderItem = __nuxt_component_0$1;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-orders app-card" }, _attrs))} data-v-30fdaf9b><div class="profile-orders__header" data-v-30fdaf9b><h2 class="profile-orders__title" data-v-30fdaf9b> Заказы </h2><button type="button" class="profile-orders__refresh"${ssrIncludeBooleanAttr(unref(pending)) ? " disabled" : ""} data-v-30fdaf9b> Обновить </button></div><div class="profile-orders__filters" data-v-30fdaf9b><!--[-->`);
      ssrRenderList(filters, (filter) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "profile-orders__filter--active": unref(activeFilter) === filter.key }, "profile-orders__filter"])}" data-v-30fdaf9b>${ssrInterpolate(filter.label)}</button>`);
      });
      _push(`<!--]--></div>`);
      if (unref(pending)) {
        _push(`<p class="profile-orders__state" data-v-30fdaf9b> Загружаем заказы… </p>`);
      } else if (unref(error)) {
        _push(`<p class="profile-orders__state profile-orders__state--error" data-v-30fdaf9b> Не удалось загрузить заказы </p>`);
      } else if (unref(filteredOrders).length === 0) {
        _push(`<p class="profile-orders__state" data-v-30fdaf9b> Заказов пока нет </p>`);
      } else {
        _push(`<div class="profile-orders__list" data-v-30fdaf9b><!--[-->`);
        ssrRenderList(unref(filteredOrders), (order) => {
          _push(ssrRenderComponent(_component_ProfileOrderItem, {
            key: order.id,
...
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-30fdaf9b"]]);
const _sfc_main$2 = {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppIcon = __nuxt_component_1$1$1;
      const _component_NuxtLink = __nuxt_component_0$4$1;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-favorites app-card" }, _attrs))} data-v-47de1716><div class="profile-favorites__header" data-v-47de1716><h2 class="profile-favorites__title" data-v-47de1716> Избранное </h2>`);
      if (unref(items).length) {
        _push(`<button type="button" class="profile-favorites__clear" data-v-47de1716> Очистить </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (unref(favoriteProducts).length) {
        _push(`<div class="profile-favorites__grid" data-v-47de1716><!--[-->`);
        ...
        _push(`<div class="profile-favorites__empty" data-v-47de1716>`);
        _push(ssrRenderComponent(_component_AppIcon, {
          name: "favorite",
          class: "profile-favorites__empty-icon"
        }, null, _parent));
        _push(`<div class="profile-favorites__empty-copy" data-v-47de1716><h3 class="profile-favorites__empty-title" data-v-47de1716> Пока ничего нет </h3><p class="profile-favorites__empty-text" data-v-47de1716> Добавляйте товары из каталога, чтобы быстро вернуться к ним позже. </p></div>`);
...
const __nuxt_component_9 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-47de1716"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AppBreadcrumbs = __nuxt_component_0$3;
      ...
      const _component_ProfileOrders = __nuxt_component_8;
      const _component_ProfileFavorites = __nuxt_component_9;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "profile-page" }, _attrs))} data-v-23251e77><div class="profile-page__container" data-v-23251e77>`);
      _push(ssrRenderComponent(_component_AppBreadcrumbs, { items: [
        { label: "Главная", to: "/" },
        { label: "Личный кабинет", to: "/profile" }
      ] }, null, _parent));
      _push(`<h1 class="profile-page__title" data-v-23251e77> Личный кабинет </h1><div class="profile-page__layout" data-v-23251e77>`);
      ...
      _push(`<div class="profile-page__content" data-v-23251e77>`);
      if (unref(activeProfileTab) === "data") {
        ...
        _push(`<!--]-->`);
      } else if (unref(activeProfileTab) === "orders") {
        _push(ssrRenderComponent(_component_ProfileOrders, null, null, _parent));
