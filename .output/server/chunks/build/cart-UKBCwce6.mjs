...
import { Z as getRegistrationEmailError, aK as isInvoiceEmailPending } from '../nitro/nitro.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "cart-page" }, _attrs))} data-v-0a76a3b8><div class="cart-page__container" data-v-0a76a3b8><div class="cart-page__header" data-v-0a76a3b8><button class="back-link" type="button" data-v-0a76a3b8><svg class="back-link__icon" viewBox="0 0 16 16" fill="none" data-v-0a76a3b8><path d="M10 12L6 8L10 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-0a76a3b8></path></svg><span class="back-link__text" data-v-0a76a3b8>Продолжить покупки</span></button><h1 class="cart-page__title" data-v-0a76a3b8> Корзина </h1></div><div class="cart-page__content" data-v-0a76a3b8><div class="left-column" data-v-0a76a3b8>`);
      if (!unref(sessionUser) && !unref(isSessionPending)) {
        _push(`<div class="auth-prompt app-card" data-v-0a76a3b8><p class="auth-prompt__title" data-v-0a76a3b8> Войдите или зарегистрируйтесь </p><p class="auth-prompt__text" data-v-0a76a3b8> Вы сможете отслеживать статус заказа<br data-v-0a76a3b8> и пользоваться преимуществами личного кабинета </p><button class="auth-prompt__button" type="button" data-v-0a76a3b8> Вход или регистрация </button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(cartItems).length === 0) {
        _push(`<div class="${ssrRenderClass([!unref(sessionUser) && !unref(isSessionPending) ? "card--mid" : "card--top", "card app-card"])}" data-v-0a76a3b8><div class="card__inner empty-state" data-v-0a76a3b8><p class="empty-state__title" data-v-0a76a3b8> Корзина пуста </p><p class="empty-state__subtitle" data-v-0a76a3b8> Воспользуйтесь каталогом, чтобы найти всё что нужно </p><button class="empty-state__btn" type="button" data-v-0a76a3b8> Начать покупки </button></div></div>`);
      } else {
        _push(`<div class="${ssrRenderClass([!unref(sessionUser) && !unref(isSessionPending) ? "card--mid" : "card--top", "card app-card"])}" data-v-0a76a3b8><div class="card__inner" data-v-0a76a3b8><p class="section-title" data-v-0a76a3b8> Товары </p><div class="items-header" data-v-0a76a3b8><div class="items-header__left" data-v-0a76a3b8>`);
        _push(ssrRenderComponent(_component_AppCheckbox, {
          modelValue: unref(allSelected),
          "onUpdate:modelValue": ($event) => isRef(allSelected) ? allSelected.value = $event : null
        }, null, _parent));
        _push(`<span class="items-header__count" data-v-0a76a3b8>${ssrInterpolate(unref(cartItems).length)} ${ssrInterpolate(pluralItems(unref(cartItems).length))}</span></div><button class="items-header__delete" aria-label="Удалить выбранные тиражи" data-v-0a76a3b8><svg class="items-header__delete-icon" viewBox="0 0 16 16" fill="none" data-v-0a76a3b8><path d="M2 7H14L13.4744 11.7301C13.3067 13.24 13.2228 13.995 12.8745 14.5647C12.5677 15.0666 12.1201 15.4672 11.5874 15.7168C10.9826 16 10.223 16 8.70379 16H7.29621C5.77697 16 5.01735 16 4.41263 15.7168C3.87993 15.4672 3.43233 15.0666 3.12552 14.5647C2.77722 13.995 2.69333 13.24 2.52556 11.7301L2 7Z" fill="currentColor" fill-opacity="0.64" data-v-0a76a3b8></path><path d="M1 3.5C1 2.67157 1.67157 2 2.5 2C3.32843 2 3.97177 1.24281 4.53657 0.636766C4.90168 0.244995 5.42223 0 6 0H10C10.5778 0 11.0983 0.244995 11.4634 0.636766C12.0282 1.24281 12.6716 2 13.5 2C14.3284 2 15 2.67157 15 3.5C15 4.32843 14.3284 5 13.5 5H2.5C1.67157 5 1 4.32843 1 3.5Z" fill="currentColor" fill-opacity="0.64" data-v-0a76a3b8></path></svg><span data-v-0a76a3b8>Удалить</span></button></div><div class="items-list" data-v-0a76a3b8><!--[-->`);
      ...
      _push(`</div><div class="right-column" data-v-0a76a3b8>`);
...
const cart = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0a76a3b8"]]);

export { cart as default };
//# sourceMappingURL=cart-UKBCwce6.mjs.map
