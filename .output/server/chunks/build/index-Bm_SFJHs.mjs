...
import { _ as _export_sfc, b as useRoute, g as useProfileStore, n as navigateTo, e as useFavorites, c as __nuxt_component_1$3, i as __nuxt_component_0$2$1, j as __nuxt_component_0$3, h as _sfc_main$p, a as __nuxt_component_0$5, s as setInterval, k as authClient, d as _sfc_main$C } from './server.mjs';
...
import { ak as formatCompactPhone, aj as getRussianSecondsWord, b as normalizePhoneDigits } from '../nitro/nitro.mjs';
import { _ as __nuxt_component_0$4 } from './AppButton-CB57Lp8b.mjs';
import { a as catalogProducts, _ as __nuxt_component_1$2 } from './catalog-products-Bmv70Lq9.mjs';
...
const _sfc_main$e = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "profile-sidebar" }, _attrs))} data-v-b7b84221><nav class="profile-sidebar__nav" data-v-b7b84221><!--[-->`);
      ssrRenderList(unref(navItems), (item) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "profile-sidebar__link--active": __props.activeItem === item.key }, "profile-sidebar__link"])}" data-v-b7b84221><span class="profile-sidebar__label" data-v-b7b84221>${ssrInterpolate(item.label)}</span>`);
        if (item.badge) {
          _push(`<span class="${ssrRenderClass([`profile-sidebar__badge--${item.badgeType}`, "profile-sidebar__badge"])}" data-v-b7b84221>${ssrInterpolate(item.badge)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</button>`);
      });
      _push(`<!--]--></nav><button type="button" class="profile-sidebar__logout" data-v-b7b84221><span class="profile-sidebar__logout-label" data-v-b7b84221>Выйти</span>`);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-b7b84221"]]);
...
const _sfc_main$d = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppIcon = __nuxt_component_1$3;
      const _component_AppInput = __nuxt_component_0$2$1;
...
const _sfc_main$b = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppInput = __nuxt_component_0$2$1;
      const _component_AppIcon = __nuxt_component_1$3;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-personal" }, _attrs))} data-v-a0cc5eff>`);
      ...
      _push(`<h2 class="profile-personal__title" data-v-a0cc5eff> Данные пользователя </h2><div class="profile-personal__body" data-v-a0cc5eff><div class="profile-personal__fields" data-v-a0cc5eff><div class="profile-field" data-v-a0cc5eff><label class="profile-field__label" data-v-a0cc5eff> Имя </label>`);
      ...
      _push(`</div><div class="profile-field profile-field--phone" data-v-a0cc5eff><label class="profile-field__label" data-v-a0cc5eff> Номер телефона </label>`);
      _push(ssrRenderComponent(_component_AppInput, {
        id: "profile-phone",
        ...
        suffix: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button type="button" class="profile-field__icon-button" aria-label="Редактировать номер телефона" data-v-a0cc5eff${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppIcon, {
              name: "profile-edit",
              size: "12",
      ...
      _push(`</div><div class="profile-personal__email-row" data-v-a0cc5eff><div class="profile-field" data-v-a0cc5eff><label class="profile-field__label" data-v-a0cc5eff> Электронная почта </label>`);
      _push(ssrRenderComponent(_component_AppInput, {
        id: "profile-email",
        ...
        suffix: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button type="button" class="profile-field__icon-button" aria-label="Редактировать почту" data-v-a0cc5eff${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppIcon, {
              name: "profile-edit",
              size: "12",
              class: "profile-field__icon"
      ...
      if (unref(showEmailActions)) {
        _push(`<div class="profile-personal__email-actions" data-v-a0cc5eff><button type="button" class="profile-personal__email-save"${ssrIncludeBooleanAttr(unref(isEmailSaving)) ? " disabled" : ""} data-v-a0cc5eff> Сохранить </button><button type="button" class="profile-personal__email-cancel"${ssrIncludeBooleanAttr(unref(isEmailSaving)) ? " disabled" : ""} data-v-a0cc5eff> Отменить </button></div>`);
      } else if (email.value && !__props.isEmailVerified) {
        _push(`<button type="button" class="profile-personal__confirm"${ssrIncludeBooleanAttr(unref(isEmailConfirmationSending)) ? " disabled" : ""} data-v-a0cc5eff>${ssrInterpolate(unref(isEmailConfirmationSending) ? "Отправляем" : "Подтвердить")}</button>`);
      } else if (email.value && __props.isEmailVerified) {
        _push(`<span class="profile-personal__verified" data-v-a0cc5eff> Подтверждена </span>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(emailConfirmationError)) {
        _push(`<p class="profile-personal__email-error" data-v-a0cc5eff>${ssrInterpolate(unref(emailConfirmationError))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="profile-field" data-v-a0cc5eff><label class="profile-field__label" data-v-a0cc5eff> Дополнительный контакт </label>`);
      _push(ssrRenderComponent(_component_AppInput, {
      ...
      _push(`</div></div><div class="profile-recipient" data-v-a0cc5eff><div class="profile-recipient__header" data-v-a0cc5eff><h3 class="profile-recipient__title" data-v-a0cc5eff> Получатель </h3><p class="profile-recipient__subtitle" data-v-a0cc5eff> Человек, который получит заказ </p></div>`);
      if (unref(recipientForms).length) {
        _push(`<div class="profile-recipient__forms" data-v-a0cc5eff><!--[-->`);
        ssrRenderList(unref(recipientForms), (recipient) => {
          _push(`<article class="profile-recipient-form" data-v-a0cc5eff><div class="profile-field" data-v-a0cc5eff><label class="profile-field__label" data-v-a0cc5eff> Имя </label>`);
          _push(ssrRenderComponent(_component_AppInput, {
            ...
            suffix: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button type="button" class="profile-field__icon-button" aria-label="Редактировать имя получателя" data-v-a0cc5eff${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
                  name: "profile-edit",
                  size: "12",
                  class: "profile-field__icon"
          ...
          _push(ssrRenderComponent(_component_AppInput, {
            ...
            suffix: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button type="button" class="profile-field__icon-button" aria-label="Редактировать номер получателя" data-v-a0cc5eff${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
                  name: "profile-edit",
                  size: "12",
                  class: "profile-field__icon"
          ...
          _push(`</div><div class="profile-recipient-form__actions" data-v-a0cc5eff><button type="button" class="profile-recipient-form__remove" data-v-a0cc5eff>`);
          _push(ssrRenderComponent(_component_AppIcon, {
            name: "profile-trash",
            size: "12",
            class: "profile-recipient-form__action-icon"
          }, null, _parent));
          _push(`<span data-v-a0cc5eff>Удалить</span></button>`);
          if (canSaveRecipient(recipient)) {
            _push(`<button type="button" class="profile-recipient-form__save" data-v-a0cc5eff> Сохранить </button>`);
          } else if (recipient.isSaveNoticeVisible) {
            _push(`<span class="profile-recipient-form__saved" data-v-a0cc5eff> Сохранен </span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></article>`);
      ...
      _push(`<div class="profile-recipient__toggle" data-v-a0cc5eff><div class="profile-recipient__toggle-copy" data-v-a0cc5eff><span class="profile-recipient__toggle-title" data-v-a0cc5eff>Добавить получателя</span><span class="profile-recipient__toggle-text" data-v-a0cc5eff> Добавьте людей, которые могут получить заказ за вас </span></div><button type="button" class="profile-recipient__add" data-v-a0cc5eff>`);
      _push(ssrRenderComponent(_component_AppIcon, {
        name: "profile-plus",
        size: "10",
        class: "profile-recipient__button-icon"
      }, null, _parent));
      _push(`<span data-v-a0cc5eff>Добавить</span></button></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-a0cc5eff"]]);
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-807a1b06"]]);
const _sfc_main$9 = {
...
const __nuxt_component_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-147f4ba0"]]);
...
const _sfc_main$5 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-password" }, _attrs))} data-v-f4dd13ec><h2 class="profile-password__title" data-v-f4dd13ec> Пароль </h2><div class="profile-password__content" data-v-f4dd13ec>`);
      if (unref(isChangingPassword)) {
        _push(`<div class="profile-password-change" data-v-f4dd13ec><div class="profile-password-change__field-group" data-v-f4dd13ec><div class="profile-password-row__label-wrap" data-v-f4dd13ec><span class="profile-password-row__label" data-v-f4dd13ec>Изменение пароля</span></div>`);
        _push(ssrRenderComponent(_component_AppInput, {
          ...
          suffix: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(currentPasswordError) && unref(currentPassword)) {
                _push2(`<button type="button" class="profile-password-change__password-toggle profile-password-change__password-toggle--clear" aria-label="Очистить текущий пароль" data-v-f4dd13ec${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
                  name: "reset",
                  size: 16,
                ...
                _push2(`<button type="button" class="profile-password-change__password-toggle"${ssrRenderAttr("aria-label", unref(isCurrentPasswordVisible) ? "Скрыть пароль" : "Показать пароль")} data-v-f4dd13ec${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
          ...
          suffix: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(newPasswordError) && unref(newPassword)) {
                _push2(`<button type="button" class="profile-password-change__password-toggle profile-password-change__password-toggle--clear" aria-label="Очистить новый пароль" data-v-f4dd13ec${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
                  name: "reset",
                  size: 16,
                  class: "profile-password-change__password-toggle-icon"
                ...
                _push2(`<button type="button" class="profile-password-change__password-toggle"${ssrRenderAttr("aria-label", unref(isNewPasswordVisible) ? "Скрыть пароль" : "Показать пароль")} data-v-f4dd13ec${_scopeId}>`);
                _push2(ssrRenderComponent(_component_AppIcon, {
        ...
        if (unref(passwordChangeMessage)) {
          _push(`<div class="profile-password__saved" data-v-f4dd13ec>${ssrInterpolate(unref(passwordChangeMessage))}</div>`);
        } else {
          _push(`<button type="button" class="profile-password__button profile-password__button--save"${ssrIncludeBooleanAttr(unref(passwordChangePending)) ? " disabled" : ""} data-v-f4dd13ec>${ssrInterpolate(unref(passwordChangePending) ? "Сохраняем" : "Сохранить")}</button>`);
        }
        _push(`</div>`);
      } else {
        _push(`<div class="profile-password-row profile-password-row--current" data-v-f4dd13ec><div class="profile-password-row__label-wrap" data-v-f4dd13ec><span class="profile-password-row__label" data-v-f4dd13ec>Текущий пароль</span></div><button type="button" class="profile-password__button" data-v-f4dd13ec> Изменить </button></div>`);
      }
      if (unref(passwordChangeError)) {
        _push(`<p class="profile-password__status profile-password__status--error" data-v-f4dd13ec>${ssrInterpolate(unref(passwordChangeError))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="profile-password-row profile-password-row--recovery" data-v-f4dd13ec><div class="profile-password-row__label-wrap" data-v-f4dd13ec><span class="profile-password-row__label" data-v-f4dd13ec>Забыли пароль?</span></div><button type="button" class="profile-password__button"${ssrIncludeBooleanAttr(unref(isPasswordRecoveryPending)) ? " disabled" : ""} data-v-f4dd13ec>${ssrInterpolate(unref(isPasswordRecoveryPending) ? "Отправляем" : "Восстановить")}</button></div>`);
      if (unref(passwordRecoveryError)) {
        _push(`<p class="profile-password__status profile-password__status--error" data-v-f4dd13ec>${ssrInterpolate(unref(passwordRecoveryError))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_5 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["__scopeId", "data-v-f4dd13ec"]]), { __name: "ProfilePasswordSettings" });
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppIcon = __nuxt_component_1$3;
      const _component_UModal = _sfc_main$p;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-danger" }, _attrs))} data-v-7b7ab256><h2 class="profile-danger__title" data-v-7b7ab256> Опасная зона </h2><div class="profile-danger__body" data-v-7b7ab256><div class="profile-danger__copy" data-v-7b7ab256><span class="profile-danger__action-title" data-v-7b7ab256>Удалить аккаунт</span><span class="profile-danger__text" data-v-7b7ab256> Все данные и история заказов будут удалены безвозвратно </span></div>`);
      if (unref(isConfirming)) {
        _push(`<div class="profile-danger__confirm-actions" data-v-7b7ab256>`);
        ...
        _push(ssrRenderComponent(_component_AppButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span data-v-7b7ab256${_scopeId}>Удалить</span>`);
            } else {
              return [
                createVNode(_component_AppIcon, {
                  name: "profile-trash",
        ...
        _push(`<div class="profile-danger__pending" data-v-7b7ab256>`);
        _push(ssrRenderComponent(_component_AppButton, {
          variant: "negative",
          size: "sm",
        ...
        if (unref(isCountdown)) {
          _push(`<p class="profile-danger__hint" data-v-7b7ab256> Подтвердить удаление аккаунта<br data-v-7b7ab256> можно будет через ${ssrInterpolate(unref(secondsLeft))} ${ssrInterpolate(unref(secondsWord))}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(ssrRenderComponent(_component_UModal, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="delete-account-modal" data-v-7b7ab256${_scopeId}><header class="delete-account-modal__header" data-v-7b7ab256${_scopeId}><div class="delete-account-modal__title-block" data-v-7b7ab256${_scopeId}><h2 class="delete-account-modal__title" data-v-7b7ab256${_scopeId}> Удаление аккаунта </h2><p class="delete-account-modal__text" data-v-7b7ab256${_scopeId}> Вы уверены, что хотите удалить Ваш аккаунт? Все данные и история заказов будут удалены безвозвратно. Вам будет необходимо регистрироваться заново. </p></div><button type="button" class="delete-account-modal__close" aria-label="Закрыть удаление аккаунта" data-v-7b7ab256${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppIcon, {
              name: "close",
              size: 16,
            ...
            if (unref(deleteError)) {
              _push2(`<p class="delete-account-modal__error" data-v-7b7ab256${_scopeId}>${ssrInterpolate(unref(deleteError))}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="delete-account-modal__actions" data-v-7b7ab256${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppButton, {
              variant: "secondary",
              size: "sm",
            ...
            _push2(ssrRenderComponent(_component_AppButton, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-7b7ab256${_scopeId2}>${ssrInterpolate(unref(isDeleting) ? "Удаляем" : "Удалить")}</span>`);
                } else {
                  return [
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-7b7ab256"]]);
const _sfc_main$3 = {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${ssrRenderAttrs(mergeProps({ class: "profile-favorite-card" }, _attrs))} data-v-ba7c5cb9><div class="profile-favorite-card__media" data-v-ba7c5cb9>`);
      if (unref(activeImage)) {
        _push(`<img${ssrRenderAttr("src", unref(activeImage))}${ssrRenderAttr("alt", __props.title)} class="profile-favorite-card__image" data-v-ba7c5cb9>`);
      } else {
        _push(`<div class="profile-favorite-card__image profile-favorite-card__image--empty" data-v-ba7c5cb9>`);
        _push(ssrRenderComponent(_component_UIcon, { name: "i-lucide-image" }, null, _parent));
        _push(`</div>`);
      }
      _push(`<div class="profile-favorite-card__overlay" data-v-ba7c5cb9>`);
      _push(ssrRenderComponent(_component_AppFavoriteButton, {
        active: "",
        onChange: ($event) => _ctx.$emit("remove")
      }, null, _parent));
      _push(`</div></div><div class="profile-favorite-card__content" data-v-ba7c5cb9><h3 class="profile-favorite-card__title" data-v-ba7c5cb9>${ssrInterpolate(__props.title)}</h3></div></article>`);
    };
  }
};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ba7c5cb9"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-favorites" }, _attrs))} data-v-ef594ba0><div class="profile-favorites__header" data-v-ef594ba0><h2 class="profile-favorites__title" data-v-ef594ba0> Избранное </h2>`);
      if (unref(items).length) {
        _push(`<button type="button" class="profile-favorites__clear" data-v-ef594ba0> Очистить </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (unref(favoriteProducts).length) {
        _push(`<div class="profile-favorites__grid" data-v-ef594ba0><!--[-->`);
        ...
        _push(`<div class="profile-favorites__empty" data-v-ef594ba0>`);
        _push(ssrRenderComponent(_component_AppIcon, {
          name: "favorite",
          class: "profile-favorites__empty-icon"
        }, null, _parent));
        _push(`<div class="profile-favorites__empty-copy" data-v-ef594ba0><h3 class="profile-favorites__empty-title" data-v-ef594ba0> Пока ничего нет </h3><p class="profile-favorites__empty-text" data-v-ef594ba0> Добавляйте товары из каталога, чтобы быстро вернуться к ним позже. </p></div>`);
...
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ef594ba0"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "profile-page" }, _attrs))} data-v-312e0afe><div class="profile-page__container" data-v-312e0afe>`);
      _push(ssrRenderComponent(_component_AppBreadcrumbs, { items: [
        { label: "Главная", to: "/" },
        { label: "Личный кабинет", to: "/profile" }
      ] }, null, _parent));
      _push(`<h1 class="profile-page__title" data-v-312e0afe> Личный кабинет </h1><div class="profile-page__layout" data-v-312e0afe>`);
      ...
      _push(`<div class="profile-page__content" data-v-312e0afe>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-312e0afe"]]);

export { index as default };
//# sourceMappingURL=index-Bm_SFJHs.mjs.map
