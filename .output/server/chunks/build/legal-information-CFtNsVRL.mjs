...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "legal-page" }, _attrs))} data-v-0b4cccba><div class="legal-page__container" data-v-0b4cccba><div class="legal-page__intro" data-v-0b4cccba>`);
      _push(ssrRenderComponent(_component_AppBreadcrumbs, {
        items: breadcrumbs,
        class: "legal-page__breadcrumbs"
      }, null, _parent));
      _push(`<h1 class="legal-page__title" data-v-0b4cccba> Правовая информация </h1></div><ul class="legal-page__list" data-v-0b4cccba><!--[-->`);
      ssrRenderList(legalPages, (item) => {
        _push(`<li class="legal-page__item" data-v-0b4cccba>`);
...
const legalInformation = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0b4cccba"]]);

export { legalInformation as default };
//# sourceMappingURL=legal-information-CFtNsVRL.mjs.map
