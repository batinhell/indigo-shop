import { _ as _export_sfc, e as useCart, s as authClient, f as useSeoMeta, n as __nuxt_component_3$1, t as __nuxt_component_5$1, v as navigateTo, i as __vite_glob_0_37, k as getFabricLabel, l as calcUnitPrice, m as calcDesignPrice, F as FABRICS, M as MOUNTINGS, S as SIZES, o as formatPriceRaw, p as useProfileStore, b as __nuxt_component_0$1, a as __nuxt_component_0$4, q as __nuxt_component_0$3, h as _sfc_main$w, g as __nuxt_component_1$1, w as setInterval, d as useFetch } from './server.mjs';
import { _ as __nuxt_component_2$1 } from './QuantityInput-DDAsTC6o.mjs';
import { computed, ref, watch, mergeProps, unref, isRef, useModel, withCtx, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, mergeModels, Fragment, renderList, useSSRContext } from 'vue';
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-e04f9a42"]]), { __name: "CartItemRow" });
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "personal-data-card app-card" }, _attrs))} data-v-6ad32b76><div class="personal-data-card__inner" data-v-6ad32b76><p class="section-title" data-v-6ad32b76> Данные пользователя </p><div class="personal-data-form" data-v-6ad32b76><div class="field-list" data-v-6ad32b76><div class="field-row" data-v-6ad32b76><label class="field-label" data-v-6ad32b76>Имя</label>`);
      ...
      _push(`</div><div class="field-row" data-v-6ad32b76><label class="field-label" data-v-6ad32b76>Номер телефона</label>`);
      _push(ssrRenderComponent(_component_AppInput, {
      ...
      _push(`</div><div class="field-row" data-v-6ad32b76><label class="field-label" data-v-6ad32b76>Электронная почта</label><div class="field-control" data-v-6ad32b76>`);
      _push(ssrRenderComponent(_component_AppInput, {
      ...
      if (unref(userEmailError)) {
        _push(`<p id="cart-user-email-error" class="field-error" data-v-6ad32b76>${ssrInterpolate(unref(userEmailError))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="field-row" data-v-6ad32b76><label class="field-label" data-v-6ad32b76>Дополнительный контакт</label>`);
      _push(ssrRenderComponent(_component_AppInput, {
        modelValue: unref(userContact),
        "onUpdate:modelValue": ($event) => isRef(userContact) ? userContact.value = $event : null
      }, null, _parent));
      _push(`</div></div><div class="switch-row" data-v-6ad32b76><span class="switch-row__label" data-v-6ad32b76>Заберёт другой человек</span>`);
      ...
      if (unref(anotherPerson)) {
        _push(`<div class="field-list" data-v-6ad32b76><div class="field-row" data-v-6ad32b76><label class="field-label" data-v-6ad32b76>Имя</label>`);
        _push(ssrRenderComponent(_component_AppInput, {
      ...
      _push(`<div class="switch-row" data-v-6ad32b76><span class="switch-row__label" data-v-6ad32b76>Оплатить как Юрлицо</span>`);
      _push(ssrRenderComponent(_component_AppSwitch, {
      ...
      _push(`</div>`);
      if (payAsLegal.value) {
        _push(`<div class="legal-section" data-v-6ad32b76>`);
        if (unref(shouldShowOrganizationList)) {
          _push(`<div class="organization-row" data-v-6ad32b76><p class="field-label organization-row__label" data-v-6ad32b76> Выбрать организацию </p><div class="organization-list" data-v-6ad32b76><!--[-->`);
          ssrRenderList(unref(displayOrganizations), (organization) => {
            _push(`<label class="${ssrRenderClass([{ "organization-option--active": unref(selectedOrganizationId) === organization.id }, "organization-option"])}" data-v-6ad32b76><input${ssrIncludeBooleanAttr(ssrLooseEqual(unref(selectedOrganizationId), organization.id)) ? " checked" : ""} class="organization-option__input" type="radio"${ssrRenderAttr("value", organization.id)} data-v-6ad32b76><span class="organization-option__top" data-v-6ad32b76><span class="organization-option__radio" data-v-6ad32b76></span><button class="organization-option__remove" type="button" data-v-6ad32b76> Удалить </button></span><span class="organization-option__content" data-v-6ad32b76><span class="organization-option__name" data-v-6ad32b76>${ssrInterpolate(organization.name)}</span><span class="organization-option__meta" data-v-6ad32b76>${ssrInterpolate(organization.innLabel)}</span>`);
            if (organization.address) {
              _push(`<span class="organization-option__meta" data-v-6ad32b76>${ssrInterpolate(organization.address)}</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</span></label>`);
        ...
        _push(`<div class="add-organization" data-v-6ad32b76><div class="add-organization__text" data-v-6ad32b76><p class="add-organization__title" data-v-6ad32b76> Добавить организацию </p><p class="add-organization__subtitle" data-v-6ad32b76> Чтобы платить безналом<br data-v-6ad32b76> и пользоваться ЭДО </p></div>`);
        if (!unref(isAddOrganizationMode)) {
          _push(`<button class="add-button" type="button" data-v-6ad32b76><span class="add-button__icon" data-v-6ad32b76>+</span><span data-v-6ad32b76>Добавить</span></button>`);
        } else {
          _push(`<div class="add-organization__control" data-v-6ad32b76>`);
          _push(ssrRenderComponent(_component_AppInput, {
          ...
          if (unref(shouldShowOrganizationSuggestions)) {
            _push(`<div class="add-organization__options" data-v-6ad32b76>`);
            if (unref(isOrganizationSuggestPending)) {
              _push(`<p class="add-organization__status" data-v-6ad32b76> Ищем организацию </p>`);
            } else if (unref(organizationSuggestError)) {
              _push(`<p class="add-organization__status add-organization__status--error" data-v-6ad32b76>${ssrInterpolate(unref(organizationSuggestError))}</p>`);
            } else {
              _push(`<!--[-->`);
              ssrRenderList(unref(organizationSuggestions), (suggestion) => {
                _push(`<button type="button" class="add-organization__option" data-v-6ad32b76><span class="add-organization__option-name" data-v-6ad32b76>${ssrInterpolate(suggestion.name)}</span>`);
                if (suggestion.inn) {
                  _push(`<span class="add-organization__option-meta" data-v-6ad32b76> ИНН ${ssrInterpolate(suggestion.inn)}</span>`);
                } else {
                  _push(`<!---->`);
                }
                if (suggestion.address) {
                  _push(`<span class="add-organization__option-meta" data-v-6ad32b76>${ssrInterpolate(suggestion.address)}</span>`);
                } else {
                  _push(`<!---->`);
                }
                _push(`</button>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-6ad32b76"]]);
const _sfc_main$5 = {};
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4eceec81"]]), { __name: "CartPickup" });
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sidebar-sticky" }, _attrs))} data-v-ee7a47a8>`);
      if (__props.totalItems === 0) {
        _push(`<div class="summary-card summary-card--empty app-card" data-v-ee7a47a8><p class="section-title" data-v-ee7a47a8> Пусто </p><button class="pay-btn pay-btn--empty" type="button" disabled data-v-ee7a47a8> Оплатить заказ </button></div>`);
      } else {
        _push(`<div class="summary-card app-card" data-v-ee7a47a8><p class="section-title" data-v-ee7a47a8> Товары </p><div class="summary-rows" data-v-ee7a47a8><div class="summary-row" data-v-ee7a47a8><span class="summary-row__label" data-v-ee7a47a8>Товары (${ssrInterpolate(__props.totalItems)})</span><span class="summary-row__value" data-v-ee7a47a8>${ssrInterpolate(unref(formatPriceRaw)(__props.totalPrice))} ₽</span></div><div class="summary-row" data-v-ee7a47a8><span class="summary-row__label" data-v-ee7a47a8>Доставка</span><span class="summary-row__value" data-v-ee7a47a8>Самовывоз</span></div></div><div class="summary-divider" data-v-ee7a47a8></div><div class="summary-total" data-v-ee7a47a8><span class="summary-total__label" data-v-ee7a47a8>К оплате</span><span class="summary-total__value" data-v-ee7a47a8>${ssrInterpolate(unref(formatPriceRaw)(__props.totalPrice))} ₽</span></div><button class="${ssrRenderClass([{ "pay-btn--pending": __props.payPending }, "pay-btn"])}"${ssrIncludeBooleanAttr(__props.payDisabled || __props.payPending) ? " disabled" : ""} data-v-ee7a47a8>`);
        if (__props.payPending) {
          _push(`<span class="pay-btn__spinner" aria-hidden="true" data-v-ee7a47a8></span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<span data-v-ee7a47a8>${ssrInterpolate(unref(payButtonLabel))}</span></button><p class="summary-consent" data-v-ee7a47a8> Нажимая на кнопку, вы соглашаетесь `);
      ...
      _push(`<div class="help-card app-card" data-v-ee7a47a8><div class="help-card__info" data-v-ee7a47a8><div class="help-card__text" data-v-ee7a47a8><p class="help-card__title" data-v-ee7a47a8> Нужна помощь с заказом? </p><p class="help-card__subtitle" data-v-ee7a47a8> Напишите нам на почту или позвоните администратору </p></div></div><div class="help-card__actions" data-v-ee7a47a8><a href="mailto:info@indigo-mail.ru" class="help-card__action help-card__action--mail" aria-label="Написать на почту" data-v-ee7a47a8><img${ssrRenderAttr("src", unref(helpMailIcon))} class="help-card__icon" alt="" aria-hidden="true" data-v-ee7a47a8></a><a href="tel:+79491314544" class="help-card__action help-card__action--phone" aria-label="Позвонить администратору" data-v-ee7a47a8><img${ssrRenderAttr("src", unref(helpPhoneIcon))} class="help-card__icon" alt="" aria-hidden="true" data-v-ee7a47a8></a></div></div></div>`);
    };
  }
};
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-ee7a47a8"]]);
...
const _sfc_main$3 = {
  ...
  emits: /* @__PURE__ */ mergeModels(["retry"], ["update:modelValue"]),
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="payment-qr-card" data-v-4088e014${_scopeId}><div class="payment-qr-card__top" data-v-4088e014${_scopeId}><div class="payment-qr-card__amount" data-v-4088e014${_scopeId}><p class="payment-qr-card__label" data-v-4088e014${_scopeId}> Итого к оплате: </p><p class="payment-qr-card__price" data-v-4088e014${_scopeId}>${ssrInterpolate(unref(formattedAmount))}</p></div><p class="payment-qr-card__timer" data-v-4088e014${_scopeId}> Осталось ${ssrInterpolate(unref(countdown))}</p></div><div class="payment-qr-card__qr-block" data-v-4088e014${_scopeId}><p class="payment-qr-card__hint" data-v-4088e014${_scopeId}>${ssrInterpolate(unref(statusText))}</p><div class="payment-qr-card__qr-frame" data-v-4088e014${_scopeId}>`);
            if (unref(isLoading)) {
              _push2(`<div class="payment-qr-card__loader" data-v-4088e014${_scopeId}></div>`);
            } else if (unref(isFailed)) {
              _push2(`<div class="payment-qr-card__failed-mark" aria-hidden="true" data-v-4088e014${_scopeId}> ! </div>`);
            } else {
              _push2(`<img${ssrRenderAttr("src", unref(qrSource))} alt="QR-код для оплаты" class="payment-qr-card__qr" data-v-4088e014${_scopeId}>`);
            }
            _push2(`</div>`);
            if (__props.qrPayload && !unref(isPaid) && !unref(isFailed)) {
              _push2(`<a${ssrRenderAttr("href", __props.qrPayload)} class="payment-qr-card__pay-link" target="_blank" rel="noopener noreferrer" data-v-4088e014${_scopeId}> Открыть в банковском приложении </a>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.error) {
              _push2(`<p class="payment-qr-card__error" data-v-4088e014${_scopeId}>${ssrInterpolate(__props.error)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(isFailed)) {
            ...
            _push2(`</div><div class="payment-qr-card__footer" data-v-4088e014${_scopeId}><div class="payment-qr-card__lock" aria-hidden="true" data-v-4088e014${_scopeId}><img${ssrRenderAttr("src", unref(lockIcon))} alt="" data-v-4088e014${_scopeId}></div><p class="payment-qr-card__secure-text" data-v-4088e014${_scopeId}> Платежи обрабатывает ВТБ.<br data-v-4088e014${_scopeId}> Мы не получаем и не храним ваши банковские данные. </p><img${ssrRenderAttr("src", unref(vtbLogo))} alt="ВТБ" class="payment-qr-card__vtb" data-v-4088e014${_scopeId}></div></section>`);
          } else {
            return [
              createVNode("section", { class: "payment-qr-card" }, [
                createVNode("div", { class: "payment-qr-card__top" }, [
                  ...
                  createVNode("p", { class: "payment-qr-card__timer" }, " Осталось " + toDisplayString(unref(countdown)), 1)
                ]),
                createVNode("div", { class: "payment-qr-card__qr-block" }, [
                  ...
                  createVNode("div", { class: "payment-qr-card__qr-frame" }, [
                    ...
                    })) : unref(isFailed) ? (openBlock(), createBlock("div", {
                      key: 1,
                  ...
                  unref(isFailed) ? (openBlock(), createBlock(_component_AppButton, {
                    key: 2,
                    size: "m",
                    onClick: ($event) => emit("retry")
                  }, {
...
const __nuxt_component_6 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-4088e014"]]), { __name: "PaymentQrModal" });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.invoice) {
              _push2(`<section class="invoice-card" data-v-701f6520${_scopeId}><div class="invoice-card__top" data-v-701f6520${_scopeId}><div class="invoice-card__icon" data-v-701f6520${_scopeId}>`);
              _push2(ssrRenderComponent(_component_AppIcon, {
                name: "invoice-time",
                size: "24",
                class: "invoice-card__icon-svg"
              }, null, _parent2, _scopeId));
              _push2(`</div><p class="invoice-card__term" data-v-701f6520${_scopeId}> Срок поступления средств 1-3 дня </p></div><h2 class="invoice-card__title" data-v-701f6520${_scopeId}> Счёт <span data-v-701f6520${_scopeId}>№${ssrInterpolate(__props.invoice.number)}</span> сформирован и ожидает оплаты </h2><div class="invoice-card__preview" data-v-701f6520${_scopeId}><div class="invoice-card__row" data-v-701f6520${_scopeId}><p class="invoice-card__label" data-v-701f6520${_scopeId}> Поставщик: </p><p class="invoice-card__value" data-v-701f6520${_scopeId}>${ssrInterpolate(unref(seller).name)}<br data-v-701f6520${_scopeId}> ИНН ${ssrInterpolate(unref(seller).inn)}</p></div><div class="invoice-card__row" data-v-701f6520${_scopeId}><p class="invoice-card__label" data-v-701f6520${_scopeId}> Покупатель: </p><p class="invoice-card__value" data-v-701f6520${_scopeId}>${ssrInterpolate(unref(payer).name)}<br data-v-701f6520${_scopeId}> ИНН ${ssrInterpolate(unref(payer).inn)}</p></div><div class="invoice-card__divider" data-v-701f6520${_scopeId}></div><div class="invoice-card__row" data-v-701f6520${_scopeId}><p class="invoice-card__label" data-v-701f6520${_scopeId}> К оплате: </p><p class="invoice-card__value" data-v-701f6520${_scopeId}>${ssrInterpolate(Number(__props.invoice.amount || 0).toLocaleString("ru-RU", { minimumFractionDigits: 2, maximumFractionDigits: 2 }))} ₽,<br data-v-701f6520${_scopeId}> без НДС </p></div></div>`);
              _push2(ssrRenderComponent(_component_AppButton, {
              ...
              _push2(`<p class="invoice-card__note" data-v-701f6520${_scopeId}>${ssrInterpolate(unref(emailStatusPrefix))} `);
...
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-701f6520"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_OrderSuccessModal = __nuxt_component_7;
      const _component_InvoiceSuccessModal = __nuxt_component_8;
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "cart-page" }, _attrs))} data-v-abd2de72><div class="cart-page__container" data-v-abd2de72><div class="cart-page__header" data-v-abd2de72><button class="back-link" type="button" data-v-abd2de72><svg class="back-link__icon" viewBox="0 0 16 16" fill="none" data-v-abd2de72><path d="M10 12L6 8L10 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-abd2de72></path></svg><span class="back-link__text" data-v-abd2de72>Продолжить покупки</span></button><h1 class="cart-page__title" data-v-abd2de72> Корзина </h1></div><div class="cart-page__content" data-v-abd2de72><div class="left-column" data-v-abd2de72>`);
      if (!unref(sessionUser) && !unref(isSessionPending)) {
        _push(`<div class="auth-prompt app-card" data-v-abd2de72><p class="auth-prompt__title" data-v-abd2de72> Войдите или зарегистрируйтесь </p><p class="auth-prompt__text" data-v-abd2de72> Вы сможете отслеживать статус заказа<br data-v-abd2de72> и пользоваться преимуществами личного кабинета </p><button class="auth-prompt__button" type="button" data-v-abd2de72> Вход или регистрация </button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(cartItems).length === 0) {
        _push(`<div class="${ssrRenderClass([!unref(sessionUser) && !unref(isSessionPending) ? "card--mid" : "card--top", "card app-card"])}" data-v-abd2de72><div class="card__inner empty-state" data-v-abd2de72><p class="empty-state__title" data-v-abd2de72> Корзина пуста </p><p class="empty-state__subtitle" data-v-abd2de72> Воспользуйтесь каталогом, чтобы найти всё что нужно </p><button class="empty-state__btn" type="button" data-v-abd2de72> Начать покупки </button></div></div>`);
      } else {
        _push(`<div class="${ssrRenderClass([!unref(sessionUser) && !unref(isSessionPending) ? "card--mid" : "card--top", "card app-card"])}" data-v-abd2de72><div class="card__inner" data-v-abd2de72><p class="section-title" data-v-abd2de72> Товары </p><div class="items-header" data-v-abd2de72><div class="items-header__left" data-v-abd2de72>`);
        _push(ssrRenderComponent(_component_AppCheckbox, {
          modelValue: unref(allSelected),
          "onUpdate:modelValue": ($event) => isRef(allSelected) ? allSelected.value = $event : null
        }, null, _parent));
        _push(`<span class="items-header__count" data-v-abd2de72>${ssrInterpolate(unref(cartItems).length)} ${ssrInterpolate(pluralItems(unref(cartItems).length))}</span></div><button class="items-header__delete" aria-label="Удалить выбранные тиражи" data-v-abd2de72><svg class="items-header__delete-icon" viewBox="0 0 16 16" fill="none" data-v-abd2de72><path d="M2 7H14L13.4744 11.7301C13.3067 13.24 13.2228 13.995 12.8745 14.5647C12.5677 15.0666 12.1201 15.4672 11.5874 15.7168C10.9826 16 10.223 16 8.70379 16H7.29621C5.77697 16 5.01735 16 4.41263 15.7168C3.87993 15.4672 3.43233 15.0666 3.12552 14.5647C2.77722 13.995 2.69333 13.24 2.52556 11.7301L2 7Z" fill="currentColor" fill-opacity="0.64" data-v-abd2de72></path><path d="M1 3.5C1 2.67157 1.67157 2 2.5 2C3.32843 2 3.97177 1.24281 4.53657 0.636766C4.90168 0.244995 5.42223 0 6 0H10C10.5778 0 11.0983 0.244995 11.4634 0.636766C12.0282 1.24281 12.6716 2 13.5 2C14.3284 2 15 2.67157 15 3.5C15 4.32843 14.3284 5 13.5 5H2.5C1.67157 5 1 4.32843 1 3.5Z" fill="currentColor" fill-opacity="0.64" data-v-abd2de72></path></svg><span data-v-abd2de72>Удалить</span></button></div><div class="items-list" data-v-abd2de72><!--[-->`);
      ...
      _push(`</div><div class="right-column" data-v-abd2de72>`);
      ...
      _push(ssrRenderComponent(_component_PaymentQrModal, {
        ...
        "expires-at": unref(payment)?.expiresAt ?? null,
        onRetry: retrySbpPayment
      }, null, _parent));
      if (unref(checkoutOrder)?.orderNumber) {
        _push(ssrRenderComponent(_component_OrderSuccessModal, {
          ...
          "order-number": unref(checkoutOrder).orderNumber,
