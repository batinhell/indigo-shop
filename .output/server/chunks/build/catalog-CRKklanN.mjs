...
import { _ as _export_sfc, aM as useFavorites, e as useCart, f as useSeoMeta, g as __nuxt_component_1$1, h as _sfc_main$w, F as FABRICS, S as SIZES, x as usePricing, y as FABRIC_IMAGE_MAP, z as MOUNTING_IMAGE_MAP, M as MOUNTINGS, n as __nuxt_component_3$2, q as __nuxt_component_0$3, A as __vite_glob_0_69, B as __vite_glob_0_68, C as __vite_glob_0_67, D as __vite_glob_0_66, E as __vite_glob_0_65, G as __vite_glob_0_64, H as __vite_glob_0_63, I as __vite_glob_0_62, J as __vite_glob_0_61, K as __vite_glob_0_60, L as __vite_glob_0_59, N as __vite_glob_0_58, O as __vite_glob_0_57, P as __vite_glob_0_56, Q as __vite_glob_0_55, R as __vite_glob_0_54, T as __vite_glob_0_53, U as __vite_glob_0_52, V as __vite_glob_0_51, W as __vite_glob_0_50, X as __vite_glob_0_49, Y as __vite_glob_0_48, Z as __vite_glob_0_47, $ as __vite_glob_0_46, a0 as __vite_glob_0_45, a1 as __vite_glob_0_44, a2 as __vite_glob_0_43, a3 as __vite_glob_0_42, a4 as __vite_glob_0_41, a5 as __vite_glob_0_40, a6 as __vite_glob_0_39, a7 as __vite_glob_0_38, i as __vite_glob_0_37, a8 as __vite_glob_0_36, a9 as __vite_glob_0_35, aa as __vite_glob_0_34, ab as __vite_glob_0_33, ac as __vite_glob_0_32, ad as __vite_glob_0_31, ae as __vite_glob_0_30, af as __vite_glob_0_29, ag as __vite_glob_0_28, ah as __vite_glob_0_27, ai as __vite_glob_0_26, aj as __vite_glob_0_25, ak as __vite_glob_0_24, al as __vite_glob_0_23, am as __vite_glob_0_22, an as __vite_glob_0_21, ao as __vite_glob_0_20, ap as __vite_glob_0_19, aq as __vite_glob_0_18, ar as __vite_glob_0_17, as as __vite_glob_0_16, at as __vite_glob_0_15, au as __vite_glob_0_14, av as __vite_glob_0_13, aw as __vite_glob_0_12, ax as __vite_glob_0_11, ay as __vite_glob_0_10, az as __vite_glob_0_9, aA as __vite_glob_0_8, aB as __vite_glob_0_7, aC as __vite_glob_0_6, aD as __vite_glob_0_5, aE as __vite_glob_0_4, aF as __vite_glob_0_3, aG as __vite_glob_0_2, aH as __vite_glob_0_1, aI as __vite_glob_0_0, aJ as MAX_UPLOAD_SIZE, aK as ALLOWED_EXTENSIONS, aL as RASTER_EXTENSIONS } from './server.mjs';
...
import { _ as __nuxt_component_0$1 } from './BaseModal-C-A_Et6t.mjs';
import { _ as __nuxt_component_2$2 } from './QuantityInput-DDAsTC6o.mjs';
import { _ as __nuxt_component_0$2 } from './AppSwitch-Bzlh0bNE.mjs';
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-0589b41a"]]);
const _sfc_main$7 = {
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-d3fe22fd"]]);
const _sfc_main$6 = {
...
const __nuxt_component_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-147728d0"]]);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-65a42be0"]]);
const _sfc_main$4 = {
  __name: "AppSelect",
  __ssrInlineRender: true,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-143d87d4><button type="button" class="app-select__trigger"${ssrIncludeBooleanAttr(__props.disabled) ? " disabled" : ""} data-v-143d87d4><span class="app-select__value" data-v-143d87d4>${ssrInterpolate(unref(selectedLabel) || __props.placeholder)}</span><svg class="app-select__chevron" viewBox="0 0 16 16" fill="none" data-v-143d87d4><path d="M4 6L8 10L12 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-143d87d4></path></svg></button>`);
      if (unref(isOpen)) {
        _push(`<div class="app-select__dropdown" data-v-143d87d4><!--[-->`);
        ssrRenderList(__props.items, (item) => {
          _push(`<button type="button" class="${ssrRenderClass([
            "app-select__item",
            { "app-select__item--selected": item.value === model.value }
          ])}" data-v-143d87d4>${ssrInterpolate(item.label)}</button>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-143d87d4"]]), { __name: "AppSelect" });
const _sfc_main$3 = {
  __name: "ProductCard",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UIcon = _sfc_main$w;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "product-card" }, _attrs))} data-v-c380fd8d><div class="product-card__image" data-v-c380fd8d>`);
      if (__props.image) {
        _push(`<img${ssrRenderAttr("src", __props.image)}${ssrRenderAttr("alt", `Флаг из ${__props.fabricGenitive}, ${__props.sizeLabel}`)} class="product-card__image-img" data-v-c380fd8d>`);
      } else {
      ...
      _push(`</div><div class="product-card__body" data-v-c380fd8d><div class="product-card__prices" data-v-c380fd8d><div class="price-row" data-v-c380fd8d><span class="price-row__label" data-v-c380fd8d>Флаг из ${ssrInterpolate(__props.fabricGenitive)}</span><div class="price-row__value" data-v-c380fd8d><span class="price-row__qty" data-v-c380fd8d>${ssrInterpolate(__props.quantity)}</span><span class="price-row__sep" data-v-c380fd8d>×</span><span class="price-row__amount" data-v-c380fd8d>${ssrInterpolate(__props.basePrice)}</span></div></div>`);
      if (__props.hasFringe) {
        _push(`<div class="price-row" data-v-c380fd8d><span class="price-row__label" data-v-c380fd8d>Бахрома</span><div class="price-row__value" data-v-c380fd8d><span class="price-row__qty" data-v-c380fd8d>${ssrInterpolate(__props.quantity)}</span><span class="price-row__sep" data-v-c380fd8d>×</span><span class="price-row__amount" data-v-c380fd8d>${ssrInterpolate(__props.fringePrice)}</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.doubleSided) {
        _push(`<div class="price-row" data-v-c380fd8d><span class="price-row__label" data-v-c380fd8d>Двухсторонняя печать</span><div class="price-row__value" data-v-c380fd8d><span class="price-row__qty" data-v-c380fd8d>${ssrInterpolate(__props.quantity)}</span><span class="price-row__sep" data-v-c380fd8d>×</span><span class="price-row__amount" data-v-c380fd8d>${ssrInterpolate(__props.doubleSidedPrice)}</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.orderDesign) {
        _push(`<div class="price-row" data-v-c380fd8d><span class="price-row__label" data-v-c380fd8d>Услуги дизайнера</span><div class="price-row__value" data-v-c380fd8d><span class="price-row__qty" data-v-c380fd8d>1</span><span class="price-row__sep" data-v-c380fd8d>×</span><span class="price-row__amount" data-v-c380fd8d>${ssrInterpolate(__props.designPrice)}</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="product-card__divider" data-v-c380fd8d></div><div class="total-row" data-v-c380fd8d><span class="total-row__label" data-v-c380fd8d>К оплате</span><span class="total-row__value" data-v-c380fd8d>${ssrInterpolate(__props.totalPrice)}</span></div></div></div><div class="product-card__actions" data-v-c380fd8d><button class="buy-btn" type="button" data-v-c380fd8d><span class="buy-btn__label" data-v-c380fd8d>Купить<span class="buy-btn__extra" data-v-c380fd8d> сразу</span></span><span class="buy-btn__payment" data-v-c380fd8d><span class="buy-btn__payment-text" data-v-c380fd8d>Оплата СБП</span><svg class="buy-btn__payment-icon" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-c380fd8d><path fill-rule="evenodd" clip-rule="evenodd" d="M5.254.093C5.257.062 5.247.024 5.272 0l.008.02c.028.084.078.157.12.234.294.527.59 1.055.885 1.582.14.259.294.51.427.773.002.551-.003 1.103.003 1.656.001.569-.002 1.138.002 1.707v.058c-.488-.297-.975-.596-1.463-.894V.093Z" fill="white" data-v-c380fd8d></path><path fill-rule="evenodd" clip-rule="evenodd" d="M5.28.02c.437.256.866.527 1.3.788 1.432.875 2.868 1.744 4.298 2.623-1.387.847-2.773 1.695-4.161 2.54-.005-.568-.001-1.138-.002-1.707.452-.273.901-.55 1.351-.824-.037-.041-.09-.062-.135-.092-.406-.246-.813-.492-1.219-.738-.133-.263-.286-.514-.427-.773-.295-.527-.59-1.054-.885-1.582A1.86 1.86 0 0 1 5.28.02Z" fill="white" data-v-c380fd8d></path><path fill-rule="evenodd" clip-rule="evenodd" d="M1.124 2.61c.004.004.011.013.015.017.018.057.043.111.075.16.343.609.684 1.218 1.026 1.826.116.201.223.409.345.606v1.57a7.16 7.16 0 0 1-.256.446c-.384.682-.766 1.366-1.15 2.047-.016.03-.026.062-.038.093l-.017.017c-.003-2.261-.003-4.522 0-6.784Z" fill="white" data-v-c380fd8d></path><path fill-rule="evenodd" clip-rule="evenodd" d="M1.214 2.787a.627.627 0 0 1-.075-.161c.479.283.95.58 1.426.867.896.548 1.793 1.096 2.69 1.644.487.298.975.596 1.463.894 1.384.846 2.769 1.692 4.153 2.537-.933.008-1.868 0-2.802.005-.45-.275-.9-.55-1.35-.826-.483-.298-.972-.588-1.452-.892-.338-.216-.684-.42-1.026-.631a12.37 12.37 0 0 1-.37-.222c-.431-.255-.856-.522-1.285-.782-.122-.198-.231-.405-.348-.605a59.42 59.42 0 0 1-1.025-1.826Z" fill="white" data-v-c380fd8d></path><path fill-rule="evenodd" clip-rule="evenodd" d="M3.87 6c.127.068.247.15.37.222.342.211.688.415 1.026.631l-.01.011c-.736.452-1.474.9-2.21 1.351-.636.386-1.267.779-1.905 1.16.012-.032.023-.064.037-.094.385-.681.766-1.365 1.15-2.047a2.24 2.24 0 0 1 .256-.447c.428-.264.858-.522 1.285-.787Z" fill="white" data-v-c380fd8d></path><path fill-rule="evenodd" clip-rule="evenodd" d="M5.266 6.854c.48.304.969.593 1.452.892-.002.549.001 1.098-.001 1.647-.404.714-.804 1.43-1.206 2.144-.08.15-.175.293-.243.45L5.261 12c-.015-.192-.003-.384-.007-.577.001-1.52-.001-3.039.001-4.558l.01-.011Z" fill="white" data-v-c380fd8d></path><path fill-rule="evenodd" clip-rule="evenodd" d="M8.068 8.572c.935-.005 1.869.002 2.803-.005-.319.206-.647.397-.969.597-1.476.901-2.951 1.802-4.427 2.703-.069.04-.134.088-.207.12.068-.157.163-.3.243-.45.403-.714.803-1.43 1.205-2.144.452-.272.904-.544 1.352-.821Z" fill="white" data-v-c380fd8d></path></svg></span></button><button class="cart-btn" type="button" data-v-c380fd8d><svg class="cart-btn__icon" viewBox="0 0 22.786 22.783" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-c380fd8d><path fill-rule="evenodd" clip-rule="evenodd" d="M6.258 15.777L2.372 3.125S1.485 3.04.99 3.028C-.02 3.004-.508.353.76.282 1.146.26 4.357 0 4.357 0l1.256 5.1 17.173.921-2.083 9.283-14.445.474ZM6.56 17.294c3.531 0 3.618 5.394.245 5.394-4.002.008-3.71-5.394-.245-5.394Zm11.916.097c3.53 0 3.62 5.392.245 5.392-4.002 0-3.707-5.392-.245-5.392Z" fill="currentColor" data-v-c380fd8d></path></svg><span class="cart-btn__text" data-v-c380fd8d>Добавить в корзину</span></button></div></div>`);
    };
  }
};
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c380fd8d"]]);
const _sfc_main$2 = {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-grid" data-v-e9b50308${_scopeId}><div class="form-column" data-v-e9b50308${_scopeId}><div class="params-section" data-v-e9b50308${_scopeId}><p class="section-title" data-v-e9b50308${_scopeId}>Параметры</p><div class="fields-grid" data-v-e9b50308${_scopeId}><div class="field-row" data-v-e9b50308${_scopeId}><label class="field-label" data-v-e9b50308${_scopeId}>Ткань</label>`);
            ...
            _push2(`</div><div class="field-row" data-v-e9b50308${_scopeId}><label class="field-label" data-v-e9b50308${_scopeId}>Тип крепления</label>`);
            _push2(ssrRenderComponent(_component_AppSelect, {
            ...
            _push2(`</div><div class="field-row" data-v-e9b50308${_scopeId}><label class="field-label" data-v-e9b50308${_scopeId}>Количество</label>`);
            ...
            _push2(`</div><div class="field-row" data-v-e9b50308${_scopeId}><label class="field-label" data-v-e9b50308${_scopeId}>Размер</label>`);
            _push2(ssrRenderComponent(_component_AppSelect, {
              modelValue: unref(selectedSize),
              "onUpdate:modelValue": ($event) => isRef(selectedSize) ? selectedSize.value = $event : null,
              items: unref(SIZES)
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="field-row field-row--options" data-v-e9b50308${_scopeId}><label class="field-label" data-v-e9b50308${_scopeId}>Опции</label><div class="options-list" data-v-e9b50308${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="layout-section" data-v-e9b50308${_scopeId}><div class="layout-section__header" data-v-e9b50308${_scopeId}><p class="section-title" data-v-e9b50308${_scopeId}>Макет</p><p class="layout-section__hint" data-v-e9b50308${_scopeId}> Подойдут файлы форматов: tiff, ai, crd, jpg, png.<br data-v-e9b50308${_scopeId}> Разрешение не менее 150 dpi, CMYK, вылеты 5 мм </p><div class="layout-section__links" data-v-e9b50308${_scopeId}><a href="#" class="layout-section__link" data-v-e9b50308${_scopeId}> Как готовить макеты к печати <svg class="layout-section__link-icon" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-e9b50308${_scopeId}><path d="M2.057 5.698a.807.807 0 0 1-1.17 0 .808.808 0 0 1 .001-.826l3.733-3.737H2.387A.569.569 0 0 1 1.82.564C1.822.252 2.075 0 2.387 0h4.538v4.534a.571.571 0 0 1-1.141.002l.006-2.572-3.733 3.734Z" fill="currentColor" data-v-e9b50308${_scopeId}></path></svg></a><a href="#" class="layout-section__link" data-v-e9b50308${_scopeId}> Шаблоны макетов <svg class="layout-section__link-icon" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-e9b50308${_scopeId}><path d="M2.057 5.698a.807.807 0 0 1-1.17 0 .808.808 0 0 1 .001-.826l3.733-3.737H2.387A.569.569 0 0 1 1.82.564C1.822.252 2.075 0 2.387 0h4.538v4.534a.571.571 0 0 1-1.141.002l.006-2.572-3.733 3.734Z" fill="currentColor" data-v-e9b50308${_scopeId}></path></svg></a></div></div><div class="design-toggle" data-v-e9b50308${_scopeId}>`);
            ...
            _push2(`</div><div class="description-field" data-v-e9b50308${_scopeId}><label class="field-label" data-v-e9b50308${_scopeId}>Описание</label><div class="${ssrRenderClass(["description-field__box", { "description-field__box--drag": unref(isDragging) }])}" data-v-e9b50308${_scopeId}><textarea class="description-field__textarea" placeholder="Сообщение для менеджера,
который будет оформлять ваш заказ" data-v-e9b50308${_scopeId}>${ssrInterpolate(unref(description2))}</textarea><div class="file-upload" data-v-e9b50308${_scopeId}><div class="file-upload__actions" data-v-e9b50308${_scopeId}><label class="file-upload__btn" data-v-e9b50308${_scopeId}><svg class="file-upload__btn-icon" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-e9b50308${_scopeId}><path d="M7.69 14.631c-1.873 0-2.81 0-3.565-.251A5.503 5.503 0 0 1 1.001 11.256c-.17-.515-.225-1.113-.243-2.033A71.69 71.69 0 0 1 .75 7.69c0-1.872 0-2.809.251-3.565A5.503 5.503 0 0 1 4.125 1.001C4.881.75 5.818.75 7.69.75s2.81 0 3.566.251a5.503 5.503 0 0 1 3.124 3.124c.251.756.251 1.693.251 3.565 0 .598 0 1.101-.008 1.533-2.997 0-5.2-1.177-7.631-1.177s-5.157.785-6.234 1.177" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" data-v-e9b50308${_scopeId}></path><circle cx="10.874" cy="3.917" r="1.256" fill="currentColor" fill-opacity="0.67" data-v-e9b50308${_scopeId}></circle><path d="M12.448 11.306v4.365M10.266 13.488h4.365" stroke="currentColor" stroke-opacity="0.67" stroke-width="1.5" stroke-linecap="round" data-v-e9b50308${_scopeId}></path><path d="M6.808 5.615 5.265 3.712a.469.469 0 0 0-.799.029L1.094 8.58h11.42L9.198 5.142a.469.469 0 0 0-.616-.083l-1.13.671a.469.469 0 0 1-.644-.115Z" fill="currentColor" fill-opacity="0.67" data-v-e9b50308${_scopeId}></path></svg><span data-v-e9b50308${_scopeId}>Выберите файл c макетом</span><input type="file" multiple accept=".tiff,.tif,.ai,.cdr,.jpg,.jpeg,.png" class="file-upload__input" data-v-e9b50308${_scopeId}></label><span class="file-upload__hint" data-v-e9b50308${_scopeId}> или перетащите<br data-v-e9b50308${_scopeId}>на страницу </span></div>`);
            if (unref(uploadedFiles).length) {
              _push2(`<div class="file-upload__files" data-v-e9b50308${_scopeId}><!--[-->`);
              ssrRenderList(unref(uploadedFiles), (file, i) => {
                _push2(`<span class="file-upload__file" data-v-e9b50308${_scopeId}><span class="file-upload__file-name" data-v-e9b50308${_scopeId}>${ssrInterpolate(file.name)}</span><button type="button" class="file-upload__file-remove" data-v-e9b50308${_scopeId}>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-e9b50308"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "catalog-page" }, _attrs))} data-v-64c4b9f6><div class="catalog-page__container" data-v-64c4b9f6>`);
      _push(ssrRenderComponent(_component_AppBreadcrumbs, {
        items: breadcrumbs,
        class: "catalog-page__breadcrumbs"
      }, null, _parent));
      _push(`<h1 class="catalog-page__title" data-v-64c4b9f6> Каталог </h1><!--[-->`);
      ssrRenderList(unref(categorySections), (category) => {
        _push(`<section${ssrRenderAttr("id", `category-${category.id}`)} class="${ssrRenderClass([{ "catalog-page__subcategory--collapsed": unref(collapsedCategories)[category.id] }, "catalog-page__subcategory"])}"${ssrRenderAttr("aria-label", `Подкатегория ${category.label}`)} data-v-64c4b9f6><div class="catalog-page__subcategory-header" data-v-64c4b9f6><div class="catalog-page__subcategory-content" data-v-64c4b9f6><h2 class="catalog-page__subcategory-title" data-v-64c4b9f6>${ssrInterpolate(category.label)}</h2><p class="catalog-page__subcategory-description" data-v-64c4b9f6>${ssrInterpolate(category.description)}</p></div><button type="button" class="catalog-page__subcategory-toggle"${ssrRenderAttr("aria-expanded", unref(collapsedCategories)[category.id] ? "false" : "true")}${ssrRenderAttr("aria-controls", `category-grid-${category.id}`)}${ssrRenderAttr("aria-label", `${unref(collapsedCategories)[category.id] ? "Развернуть" : "Свернуть"} раздел ${category.label}`)} data-v-64c4b9f6>`);
        _push(ssrRenderComponent(_component_AppIcon, {
          name: "chevron",
          size: 16,
        ...
        _push(`</button></div><div${ssrRenderAttr("id", `category-grid-${category.id}`)} class="catalog-page__grid" aria-label="Товары" style="${ssrRenderStyle(!unref(collapsedCategories)[category.id] ? null : { display: "none" })}" data-v-64c4b9f6><!--[-->`);
      ...
      _push(ssrRenderComponent(_component_ConstructorModal, {
        ...
        "product-id": unref(selectedOnlineOrderProduct)?.productId,
...
const catalog = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-64c4b9f6"]]);

export { catalog as default };
//# sourceMappingURL=catalog-CRKklanN.mjs.map
