import { _ as _export_sfc, e as useCart, s as authClient, f as useSeoMeta, n as __nuxt_component_3$1, t as __nuxt_component_5$1, i as __vite_glob_0_37, k as getFabricLabel, l as calcUnitPrice, m as calcDesignPrice, F as FABRICS, M as MOUNTINGS, S as SIZES, o as formatPriceRaw, p as useProfileStore, b as __nuxt_component_0$1, a as __nuxt_component_0$4, g as __nuxt_component_1$1, q as __nuxt_component_0$3, v as setInterval } from './server.mjs';
import { _ as __nuxt_component_2$1 } from './QuantityInput-BYipMCdR.mjs';
import { computed, ref, watch, mergeProps, unref, isRef, useModel, withCtx, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, mergeModels, useSSRContext } from 'vue';
...
import { _ as __nuxt_component_0 } from './AppSwitch-B6KdDVqJ.mjs';
import { storeToRefs } from 'pinia';
import { V as getRegistrationEmailError, aG as isInvoiceEmailPending } from '../nitro/nitro.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="payment-qr-card" data-v-1bad0021${_scopeId}><div class="payment-qr-card__top" data-v-1bad0021${_scopeId}><div class="payment-qr-card__amount" data-v-1bad0021${_scopeId}><p class="payment-qr-card__label" data-v-1bad0021${_scopeId}> Итого к оплате: </p><p class="payment-qr-card__price" data-v-1bad0021${_scopeId}>${ssrInterpolate(unref(formattedAmount))}</p></div><p class="payment-qr-card__timer" data-v-1bad0021${_scopeId}> Осталось ${ssrInterpolate(__props.expiresIn)}</p></div><div class="payment-qr-card__qr-block" data-v-1bad0021${_scopeId}><p class="payment-qr-card__hint" data-v-1bad0021${_scopeId}>${ssrInterpolate(unref(statusText))}</p><div class="payment-qr-card__qr-frame" data-v-1bad0021${_scopeId}>`);
            if (unref(isLoading)) {
              _push2(`<div class="payment-qr-card__loader" data-v-1bad0021${_scopeId}></div>`);
            } else {
              _push2(`<img${ssrRenderAttr("src", unref(qrSource))} alt="QR-код для оплаты" class="payment-qr-card__qr" data-v-1bad0021${_scopeId}>`);
            }
            _push2(`</div>`);
            if (__props.qrPayload && !unref(isPaid) && !unref(isFailed)) {
              _push2(`<a${ssrRenderAttr("href", __props.qrPayload)} class="payment-qr-card__pay-link" target="_blank" rel="noopener noreferrer" data-v-1bad0021${_scopeId}> Открыть в банковском приложении </a>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.error) {
              _push2(`<p class="payment-qr-card__error" data-v-1bad0021${_scopeId}>${ssrInterpolate(__props.error)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="payment-qr-card__footer" data-v-1bad0021${_scopeId}><div class="payment-qr-card__lock" aria-hidden="true" data-v-1bad0021${_scopeId}><img${ssrRenderAttr("src", unref(lockIcon))} alt="" data-v-1bad0021${_scopeId}></div><p class="payment-qr-card__secure-text" data-v-1bad0021${_scopeId}> Платежи обрабатывает ВТБ.<br data-v-1bad0021${_scopeId}> Мы не получаем и не храним ваши банковские данные. </p><img${ssrRenderAttr("src", unref(vtbLogo))} alt="ВТБ" class="payment-qr-card__vtb" data-v-1bad0021${_scopeId}></div></section>`);
          } else {
            return [
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1bad0021"]]);
const _sfc_main$1 = {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "cart-page" }, _attrs))} data-v-e4f09eb9><div class="cart-page__container" data-v-e4f09eb9><div class="cart-page__header" data-v-e4f09eb9><button class="back-link" type="button" data-v-e4f09eb9><svg class="back-link__icon" viewBox="0 0 16 16" fill="none" data-v-e4f09eb9><path d="M10 12L6 8L10 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-e4f09eb9></path></svg><span class="back-link__text" data-v-e4f09eb9>Продолжить покупки</span></button><h1 class="cart-page__title" data-v-e4f09eb9> Корзина </h1></div><div class="cart-page__content" data-v-e4f09eb9><div class="left-column" data-v-e4f09eb9>`);
      if (!unref(sessionUser) && !unref(isSessionPending)) {
        _push(`<div class="auth-prompt app-card" data-v-e4f09eb9><p class="auth-prompt__title" data-v-e4f09eb9> Войдите или зарегистрируйтесь </p><p class="auth-prompt__text" data-v-e4f09eb9> Вы сможете отслеживать статус заказа<br data-v-e4f09eb9> и пользоваться преимуществами личного кабинета </p><button class="auth-prompt__button" type="button" data-v-e4f09eb9> Вход или регистрация </button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(cartItems).length === 0) {
        _push(`<div class="${ssrRenderClass([!unref(sessionUser) && !unref(isSessionPending) ? "card--mid" : "card--top", "card app-card"])}" data-v-e4f09eb9><div class="card__inner empty-state" data-v-e4f09eb9><p class="empty-state__title" data-v-e4f09eb9> Корзина пуста </p><p class="empty-state__subtitle" data-v-e4f09eb9> Воспользуйтесь каталогом, чтобы найти всё что нужно </p><button class="empty-state__btn" type="button" data-v-e4f09eb9> Начать покупки </button></div></div>`);
      } else {
        _push(`<div class="${ssrRenderClass([!unref(sessionUser) && !unref(isSessionPending) ? "card--mid" : "card--top", "card app-card"])}" data-v-e4f09eb9><div class="card__inner" data-v-e4f09eb9><p class="section-title" data-v-e4f09eb9> Товары </p><div class="items-header" data-v-e4f09eb9><div class="items-header__left" data-v-e4f09eb9>`);
        _push(ssrRenderComponent(_component_AppCheckbox, {
          modelValue: unref(allSelected),
          "onUpdate:modelValue": ($event) => isRef(allSelected) ? allSelected.value = $event : null
        }, null, _parent));
        _push(`<span class="items-header__count" data-v-e4f09eb9>${ssrInterpolate(unref(cartItems).length)} ${ssrInterpolate(pluralItems(unref(cartItems).length))}</span></div><button class="items-header__delete" aria-label="Удалить выбранные тиражи" data-v-e4f09eb9><svg class="items-header__delete-icon" viewBox="0 0 16 16" fill="none" data-v-e4f09eb9><path d="M2 7H14L13.4744 11.7301C13.3067 13.24 13.2228 13.995 12.8745 14.5647C12.5677 15.0666 12.1201 15.4672 11.5874 15.7168C10.9826 16 10.223 16 8.70379 16H7.29621C5.77697 16 5.01735 16 4.41263 15.7168C3.87993 15.4672 3.43233 15.0666 3.12552 14.5647C2.77722 13.995 2.69333 13.24 2.52556 11.7301L2 7Z" fill="currentColor" fill-opacity="0.64" data-v-e4f09eb9></path><path d="M1 3.5C1 2.67157 1.67157 2 2.5 2C3.32843 2 3.97177 1.24281 4.53657 0.636766C4.90168 0.244995 5.42223 0 6 0H10C10.5778 0 11.0983 0.244995 11.4634 0.636766C12.0282 1.24281 12.6716 2 13.5 2C14.3284 2 15 2.67157 15 3.5C15 4.32843 14.3284 5 13.5 5H2.5C1.67157 5 1 4.32843 1 3.5Z" fill="currentColor" fill-opacity="0.64" data-v-e4f09eb9></path></svg><span data-v-e4f09eb9>Удалить</span></button></div><div class="items-list" data-v-e4f09eb9><!--[-->`);
      ...
      _push(`</div><div class="right-column" data-v-e4f09eb9>`);
...
const cart = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e4f09eb9"]]);

export { cart as default };
//# sourceMappingURL=cart-BFjgftv2.mjs.map
