...
import { _ as _export_sfc, aI as useFavorites, d as useCart, e as useSeoMeta, f as __nuxt_component_1$1, g as _sfc_main$u, F as FABRICS, S as SIZES, t as usePricing, v as FABRIC_IMAGE_MAP, w as MOUNTING_IMAGE_MAP, M as MOUNTINGS, m as __nuxt_component_3$2, x as __vite_glob_0_68, y as __vite_glob_0_67, z as __vite_glob_0_66, A as __vite_glob_0_65, B as __vite_glob_0_64, C as __vite_glob_0_63, D as __vite_glob_0_62, E as __vite_glob_0_61, G as __vite_glob_0_60, H as __vite_glob_0_59, I as __vite_glob_0_58, J as __vite_glob_0_57, K as __vite_glob_0_56, L as __vite_glob_0_55, N as __vite_glob_0_54, O as __vite_glob_0_53, P as __vite_glob_0_52, Q as __vite_glob_0_51, R as __vite_glob_0_50, T as __vite_glob_0_49, U as __vite_glob_0_48, V as __vite_glob_0_47, W as __vite_glob_0_46, X as __vite_glob_0_45, Y as __vite_glob_0_44, Z as __vite_glob_0_43, $ as __vite_glob_0_42, a0 as __vite_glob_0_41, a1 as __vite_glob_0_40, a2 as __vite_glob_0_39, a3 as __vite_glob_0_38, a4 as __vite_glob_0_37, h as __vite_glob_0_36, a5 as __vite_glob_0_35, a6 as __vite_glob_0_34, a7 as __vite_glob_0_33, a8 as __vite_glob_0_32, a9 as __vite_glob_0_31, aa as __vite_glob_0_30, ab as __vite_glob_0_29, ac as __vite_glob_0_28, ad as __vite_glob_0_27, ae as __vite_glob_0_26, af as __vite_glob_0_25, ag as __vite_glob_0_24, ah as __vite_glob_0_23, ai as __vite_glob_0_22, aj as __vite_glob_0_21, ak as __vite_glob_0_20, al as __vite_glob_0_19, am as __vite_glob_0_18, an as __vite_glob_0_17, ao as __vite_glob_0_16, ap as __vite_glob_0_15, aq as __vite_glob_0_14, ar as __vite_glob_0_13, as as __vite_glob_0_12, at as __vite_glob_0_11, au as __vite_glob_0_10, av as __vite_glob_0_9, aw as __vite_glob_0_8, ax as __vite_glob_0_7, ay as __vite_glob_0_6, az as __vite_glob_0_5, aA as __vite_glob_0_4, aB as __vite_glob_0_3, aC as __vite_glob_0_2, aD as __vite_glob_0_1, aE as __vite_glob_0_0, aF as MAX_UPLOAD_SIZE, aG as ALLOWED_EXTENSIONS, aH as RASTER_EXTENSIONS } from './server.mjs';
import { c as catalogCategoryItems, a as catalogProducts, _ as __nuxt_component_1$2 } from './catalog-products-Cq7yQN5v.mjs';
...
import { _ as __nuxt_component_0$1 } from './BaseModal-CJcMIqBf.mjs';
...
import { _ as __nuxt_component_0$3 } from './AppButton-nx9v3pel.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseModal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-grid" data-v-c6005d15${_scopeId}><div class="form-column" data-v-c6005d15${_scopeId}><div class="params-section" data-v-c6005d15${_scopeId}><p class="section-title" data-v-c6005d15${_scopeId}>Параметры</p><div class="fields-grid" data-v-c6005d15${_scopeId}><div class="field-row" data-v-c6005d15${_scopeId}><label class="field-label" data-v-c6005d15${_scopeId}>Ткань</label>`);
            ...
            _push2(`</div><div class="field-row" data-v-c6005d15${_scopeId}><label class="field-label" data-v-c6005d15${_scopeId}>Тип крепления</label>`);
            _push2(ssrRenderComponent(_component_AppSelect, {
            ...
            _push2(`</div><div class="field-row" data-v-c6005d15${_scopeId}><label class="field-label" data-v-c6005d15${_scopeId}>Количество</label>`);
            ...
            _push2(`</div><div class="field-row" data-v-c6005d15${_scopeId}><label class="field-label" data-v-c6005d15${_scopeId}>Размер</label>`);
            _push2(ssrRenderComponent(_component_AppSelect, {
              modelValue: unref(selectedSize),
              "onUpdate:modelValue": ($event) => isRef(selectedSize) ? selectedSize.value = $event : null,
              items: unref(SIZES)
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="field-row field-row--options" data-v-c6005d15${_scopeId}><label class="field-label" data-v-c6005d15${_scopeId}>Опции</label><div class="options-list" data-v-c6005d15${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="layout-section" data-v-c6005d15${_scopeId}><div class="layout-section__header" data-v-c6005d15${_scopeId}><p class="section-title" data-v-c6005d15${_scopeId}>Макет</p><p class="layout-section__hint" data-v-c6005d15${_scopeId}> Подойдут файлы форматов: tiff, ai, crd, jpg, png.<br data-v-c6005d15${_scopeId}> Разрешение не менее 150 dpi, CMYK, вылеты 5 мм </p><div class="layout-section__links" data-v-c6005d15${_scopeId}><a href="#" class="layout-section__link" data-v-c6005d15${_scopeId}> Как готовить макеты к печати <svg class="layout-section__link-icon" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-c6005d15${_scopeId}><path d="M2.057 5.698a.807.807 0 0 1-1.17 0 .808.808 0 0 1 .001-.826l3.733-3.737H2.387A.569.569 0 0 1 1.82.564C1.822.252 2.075 0 2.387 0h4.538v4.534a.571.571 0 0 1-1.141.002l.006-2.572-3.733 3.734Z" fill="currentColor" data-v-c6005d15${_scopeId}></path></svg></a><a href="#" class="layout-section__link" data-v-c6005d15${_scopeId}> Шаблоны макетов <svg class="layout-section__link-icon" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-c6005d15${_scopeId}><path d="M2.057 5.698a.807.807 0 0 1-1.17 0 .808.808 0 0 1 .001-.826l3.733-3.737H2.387A.569.569 0 0 1 1.82.564C1.822.252 2.075 0 2.387 0h4.538v4.534a.571.571 0 0 1-1.141.002l.006-2.572-3.733 3.734Z" fill="currentColor" data-v-c6005d15${_scopeId}></path></svg></a></div></div><div class="design-toggle" data-v-c6005d15${_scopeId}>`);
            ...
            _push2(`</div><div class="description-field" data-v-c6005d15${_scopeId}><label class="field-label" data-v-c6005d15${_scopeId}>Описание</label><div class="${ssrRenderClass(["description-field__box", { "description-field__box--drag": unref(isDragging) }])}" data-v-c6005d15${_scopeId}><textarea class="description-field__textarea" placeholder="Сообщение для менеджера,
который будет оформлять ваш заказ" data-v-c6005d15${_scopeId}>${ssrInterpolate(unref(description2))}</textarea><div class="file-upload" data-v-c6005d15${_scopeId}><div class="file-upload__actions" data-v-c6005d15${_scopeId}><label class="file-upload__btn" data-v-c6005d15${_scopeId}><svg class="file-upload__btn-icon" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-c6005d15${_scopeId}><path d="M7.69 14.631c-1.873 0-2.81 0-3.565-.251A5.503 5.503 0 0 1 1.001 11.256c-.17-.515-.225-1.113-.243-2.033A71.69 71.69 0 0 1 .75 7.69c0-1.872 0-2.809.251-3.565A5.503 5.503 0 0 1 4.125 1.001C4.881.75 5.818.75 7.69.75s2.81 0 3.566.251a5.503 5.503 0 0 1 3.124 3.124c.251.756.251 1.693.251 3.565 0 .598 0 1.101-.008 1.533-2.997 0-5.2-1.177-7.631-1.177s-5.157.785-6.234 1.177" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" data-v-c6005d15${_scopeId}></path><circle cx="10.874" cy="3.917" r="1.256" fill="currentColor" fill-opacity="0.67" data-v-c6005d15${_scopeId}></circle><path d="M12.448 11.306v4.365M10.266 13.488h4.365" stroke="currentColor" stroke-opacity="0.67" stroke-width="1.5" stroke-linecap="round" data-v-c6005d15${_scopeId}></path><path d="M6.808 5.615 5.265 3.712a.469.469 0 0 0-.799.029L1.094 8.58h11.42L9.198 5.142a.469.469 0 0 0-.616-.083l-1.13.671a.469.469 0 0 1-.644-.115Z" fill="currentColor" fill-opacity="0.67" data-v-c6005d15${_scopeId}></path></svg><span data-v-c6005d15${_scopeId}>Выберите файл c макетом</span><input type="file" multiple accept=".tiff,.tif,.ai,.cdr,.jpg,.jpeg,.png" class="file-upload__input" data-v-c6005d15${_scopeId}></label><span class="file-upload__hint" data-v-c6005d15${_scopeId}> или перетащите<br data-v-c6005d15${_scopeId}>на страницу </span></div>`);
            if (unref(uploadedFiles).length) {
              _push2(`<div class="file-upload__files" data-v-c6005d15${_scopeId}><!--[-->`);
              ssrRenderList(unref(uploadedFiles), (file, i) => {
                _push2(`<span class="file-upload__file" data-v-c6005d15${_scopeId}><span class="file-upload__file-name" data-v-c6005d15${_scopeId}>${ssrInterpolate(file.name)}</span><button type="button" class="file-upload__file-remove" data-v-c6005d15${_scopeId}>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c6005d15"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "catalog-page" }, _attrs))} data-v-07bad001><div class="catalog-page__container" data-v-07bad001>`);
      _push(ssrRenderComponent(_component_AppBreadcrumbs, {
        items: breadcrumbs,
        class: "catalog-page__breadcrumbs"
      }, null, _parent));
      _push(`<h1 class="catalog-page__title" data-v-07bad001> Каталог </h1><!--[-->`);
      ssrRenderList(unref(categorySections), (category) => {
        _push(`<section${ssrRenderAttr("id", `category-${category.id}`)} class="${ssrRenderClass([{ "catalog-page__subcategory--collapsed": unref(collapsedCategories)[category.id] }, "catalog-page__subcategory"])}"${ssrRenderAttr("aria-label", `Подкатегория ${category.label}`)} data-v-07bad001><div class="catalog-page__subcategory-header" data-v-07bad001><div class="catalog-page__subcategory-content" data-v-07bad001><h2 class="catalog-page__subcategory-title" data-v-07bad001>${ssrInterpolate(category.label)}</h2><p class="catalog-page__subcategory-description" data-v-07bad001>${ssrInterpolate(category.description)}</p></div><button type="button" class="catalog-page__subcategory-toggle"${ssrRenderAttr("aria-expanded", unref(collapsedCategories)[category.id] ? "false" : "true")}${ssrRenderAttr("aria-controls", `category-grid-${category.id}`)}${ssrRenderAttr("aria-label", `${unref(collapsedCategories)[category.id] ? "Развернуть" : "Свернуть"} раздел ${category.label}`)} data-v-07bad001>`);
        _push(ssrRenderComponent(_component_AppIcon, {
          name: "chevron",
          size: 16,
        ...
        _push(`</button></div><div${ssrRenderAttr("id", `category-grid-${category.id}`)} class="catalog-page__grid" aria-label="Товары" style="${ssrRenderStyle(!unref(collapsedCategories)[category.id] ? null : { display: "none" })}" data-v-07bad001><!--[-->`);
        ...
        _push(`<!--]--></div><div class="catalog-page__placeholder" aria-label="Разделы каталога в разработке" style="${ssrRenderStyle(!unref(collapsedCategories)[category.id] ? null : { display: "none" })}" data-v-07bad001><div class="catalog-page__placeholder-grid" aria-hidden="true" data-v-07bad001><!--[-->`);
        ssrRenderList(8, (index) => {
          _push(`<div class="catalog-page__skeleton-card" data-v-07bad001><div class="catalog-page__skeleton-image" data-v-07bad001></div><div class="catalog-page__skeleton-content" data-v-07bad001><div class="catalog-page__skeleton-line catalog-page__skeleton-line--full" data-v-07bad001></div><div class="catalog-page__skeleton-line catalog-page__skeleton-line--medium" data-v-07bad001></div><div class="catalog-page__skeleton-line catalog-page__skeleton-line--small" data-v-07bad001></div><div class="catalog-page__skeleton-line catalog-page__skeleton-line--price" data-v-07bad001></div><div class="catalog-page__skeleton-button" data-v-07bad001></div></div></div>`);
        });
        _push(`<!--]--></div><div class="catalog-page__notice" data-v-07bad001><h2 class="catalog-page__notice-title" data-v-07bad001> Мы еще работаем<br data-v-07bad001> над наполнением каталога </h2><p class="catalog-page__notice-description" data-v-07bad001> Скоро тут появятся: корпоративная продукция, товары для свадеб и оформления магазинов, фотоальбомы и товары для художников </p><img${ssrRenderAttr("src", unref(progressSmile))} alt="" class="catalog-page__notice-arrow" aria-hidden="true" data-v-07bad001></div></div></section>`);
      });
      _push(`<!--]--></div>`);
...
const catalog = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-07bad001"]]);

export { catalog as default };
//# sourceMappingURL=catalog-CjiD_vIU.mjs.map
