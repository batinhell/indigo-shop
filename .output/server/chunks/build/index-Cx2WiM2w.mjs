...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-favorites" }, _attrs))} data-v-39c60dbf><div class="profile-favorites__header" data-v-39c60dbf><h2 class="profile-favorites__title" data-v-39c60dbf> Избранное </h2>`);
      if (unref(items).length) {
        _push(`<button type="button" class="profile-favorites__clear" data-v-39c60dbf> Очистить </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (unref(favoriteProducts).length) {
        _push(`<div class="profile-favorites__grid" data-v-39c60dbf><!--[-->`);
        ...
        _push(`<div class="profile-favorites__empty" data-v-39c60dbf>`);
        _push(ssrRenderComponent(_component_AppIcon, {
          name: "favorite",
          class: "profile-favorites__empty-icon"
        }, null, _parent));
        _push(`<div class="profile-favorites__empty-copy" data-v-39c60dbf><h3 class="profile-favorites__empty-title" data-v-39c60dbf> Пока ничего нет </h3><p class="profile-favorites__empty-text" data-v-39c60dbf> Добавляйте товары из каталога, чтобы быстро вернуться к ним позже. </p></div>`);
...
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-39c60dbf"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-Cx2WiM2w.mjs.map
