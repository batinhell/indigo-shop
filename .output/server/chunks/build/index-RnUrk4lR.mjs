...
import { _ as _export_sfc, b as useRoute, s as useProfileStore, aN as navigateTo, aM as useFavorites, f as __nuxt_component_1$2, d as useCart, c as useFetch, a as __nuxt_component_0$2$1, g as _sfc_main$i } from './server.mjs';
...
import { _ as _sfc_main$h } from './Modal-iOm1f04o.mjs';
import { _ as __nuxt_component_0$4 } from './AppInput-BaFx_Bai.mjs';
import { aF as formatCompactPhone, aG as getRussianSecondsWord, b as normalizePhoneDigits } from '../nitro/nitro.mjs';
import { _ as __nuxt_component_0$5 } from './AppSwitch-B6KdDVqJ.mjs';
import { _ as __nuxt_component_0$6 } from './AppButton-nx9v3pel.mjs';
import { a as catalogProducts, _ as __nuxt_component_1$3 } from './catalog-products-Cq7yQN5v.mjs';
...
const _sfc_main$g = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "profile-sidebar app-card" }, _attrs))} data-v-07e5d540><nav class="profile-sidebar__nav" data-v-07e5d540><!--[-->`);
      ssrRenderList(unref(navItems), (item) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "profile-sidebar__link--active": __props.activeItem === item.key }, "profile-sidebar__link"])}" data-v-07e5d540><span class="profile-sidebar__label" data-v-07e5d540>${ssrInterpolate(item.label)}</span>`);
        if (item.badge) {
          _push(`<span class="${ssrRenderClass([`profile-sidebar__badge--${item.badgeType}`, "profile-sidebar__badge"])}" data-v-07e5d540>${ssrInterpolate(item.badge)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</button>`);
      });
      _push(`<!--]--></nav><button type="button" class="profile-sidebar__logout" data-v-07e5d540><span class="profile-sidebar__logout-label" data-v-07e5d540>Выйти</span>`);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-07e5d540"]]);
...
const _sfc_main$f = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppIcon = __nuxt_component_1$2;
      const _component_AppInput = __nuxt_component_0$4;
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-e269c041"]]);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-c7d6d1ab"]]);
const phoneMask = "+7(###)-###-##-##";
const _sfc_main$d = {
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-037f5a47"]]);
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-05744d24"]]);
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AppSwitch = __nuxt_component_0$5;
...
const __nuxt_component_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-bee4ae71"]]);
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UModal = _sfc_main$h;
      const _component_AppIcon = __nuxt_component_1$2;
      const _component_AppButton = __nuxt_component_0$6;
      _push(ssrRenderComponent(_component_UModal, mergeProps({
        open: isOpen.value,
        "onUpdate:open": ($event) => isOpen.value = $event,
        overlay: true,
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-6ce011a8"]]);
const _sfc_main$9 = {
...
const __nuxt_component_5 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-4e4d6ef9"]]), { __name: "ProfilePasswordSettings" });
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-61d9fb40"]]);
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="profile-order-item__top" data-v-b94ab4a5${_scopeId}><div class="profile-order-item__details" data-v-b94ab4a5${_scopeId}><div class="profile-order-item__title-row" data-v-b94ab4a5${_scopeId}><span class="${ssrRenderClass([`profile-order-item__status--${unref(statusToneName)}`, "profile-order-item__status"])}" data-v-b94ab4a5${_scopeId}>${ssrInterpolate(unref(statusLabelText))}</span><span class="profile-order-item__number" data-v-b94ab4a5${_scopeId}>${ssrInterpolate(__props.number)}</span></div><div class="profile-order-item__meta" data-v-b94ab4a5${_scopeId}><span data-v-b94ab4a5${_scopeId}>${ssrInterpolate(__props.date)}</span><span aria-hidden="true" data-v-b94ab4a5${_scopeId}>·</span><span data-v-b94ab4a5${_scopeId}>${ssrInterpolate(__props.delivery)}</span></div></div><div class="profile-order-item__actions" data-v-b94ab4a5${_scopeId}><button type="button" class="profile-order-item__button profile-order-item__button--secondary" data-v-b94ab4a5${_scopeId}> Повторить </button><span class="profile-order-item__button profile-order-item__button--primary" data-v-b94ab4a5${_scopeId}> Подробнее </span></div></div><div class="profile-order-item__bottom" data-v-b94ab4a5${_scopeId}><div class="profile-order-item__items-wrap" data-v-b94ab4a5${_scopeId}><div class="profile-order-item__items" data-v-b94ab4a5${_scopeId}><!--[-->`);
            ssrRenderList(__props.items, (item, index2) => {
              _push2(`<div class="profile-order-product" data-v-b94ab4a5${_scopeId}><div class="profile-order-product__name" data-v-b94ab4a5${_scopeId}>${ssrInterpolate(item.name)}</div><div class="profile-order-product__options" data-v-b94ab4a5${_scopeId}><span data-v-b94ab4a5${_scopeId}>${ssrInterpolate(item.size || item.sizeLabel || "—")}</span><span aria-hidden="true" data-v-b94ab4a5${_scopeId}>·</span><span data-v-b94ab4a5${_scopeId}>${ssrInterpolate(item.quantity || item.quantityLabel)}</span></div></div>`);
            });
            _push2(`<!--]--></div></div><div class="profile-order-item__fade" data-v-b94ab4a5${_scopeId}></div><div class="profile-order-item__price" data-v-b94ab4a5${_scopeId}><span class="profile-order-item__price-value" data-v-b94ab4a5${_scopeId}>${ssrInterpolate(__props.price)}</span><span class="profile-order-item__price-caption" data-v-b94ab4a5${_scopeId}>${ssrInterpolate(__props.positions)}</span></div></div>`);
          } else {
            return [
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-b94ab4a5"]]);
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "profile-orders app-card" }, _attrs))} data-v-f597da12><div class="profile-orders__header" data-v-f597da12><h2 class="profile-orders__title" data-v-f597da12> Заказы </h2><button type="button" class="profile-orders__refresh"${ssrIncludeBooleanAttr(unref(pending)) ? " disabled" : ""} data-v-f597da12> Обновить </button></div><div class="profile-orders__filters" data-v-f597da12><!--[-->`);
      ssrRenderList(filters, (filter) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "profile-orders__filter--active": unref(activeFilter) === filter.key }, "profile-orders__filter"])}" data-v-f597da12>${ssrInterpolate(filter.label)}</button>`);
      });
      _push(`<!--]--></div>`);
      if (unref(pending)) {
        _push(`<p class="profile-orders__state" data-v-f597da12> Загружаем заказы… </p>`);
      } else if (unref(error)) {
        _push(`<p class="profile-orders__state profile-orders__state--error" data-v-f597da12> Не удалось загрузить заказы </p>`);
      } else if (unref(filteredOrders).length === 0) {
        _push(`<p class="profile-orders__state" data-v-f597da12> Заказов пока нет </p>`);
      } else {
        _push(`<div class="profile-orders__list" data-v-f597da12><!--[-->`);
...
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-f597da12"]]);
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppFavoriteButton = __nuxt_component_1$3;
...
const __nuxt_component_9 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-3ff51a27"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-RnUrk4lR.mjs.map
