  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(categorySections), (category) => {
        ...
        _push(`</button></div><div${ssrRenderAttr("id", `category-grid-${category.id}`)} class="catalog-page__grid" aria-label="Товары" style="${ssrRenderStyle(!unref(collapsedCategories)[category.id] ? null : { display: "none" })}" data-v-cb099a31><!--[-->`);
